...
const docTemplate = `{
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/auth_service.DeleteManyUserRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/auth_service.ExpireSessionsRequest"
                        }
                    }
                ],
                "responses": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/auth_service.ListClientTokenResponse"
                                        }
                                    }
                                }
                            ]
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/auth_service.GetSessionListResponse"
                                        }
                                    }
                                }
                            ]
            ...
            "delete": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/auth_service.DeleteByParamsRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "delete": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/auth_service.DeleteSessionsByDeviceRequest"
                        }
                    }
                ],
                "responses": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/auth_service.GetSessionDevicesResponse"
                                        }
                                    }
                                }
                            ]
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/auth_service.SessionPrimaryKey"
                                        }
                                    }
                                }
                            ]
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/auth_service.V2UserResetPasswordRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "auth_service.DeleteByParamsRequest": {
            "type": "object",
            "properties": {
                "client_type_id": {
                    "type": "string"
        ...
        "auth_service.DeleteManyUserRequest": {
            "type": "object",
            "properties": {
                "company_id": {
                    "type": "string"
                ...
                "users": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/auth_service.DeleteManyUserRequest_User"
                    }
                }
            }
        },
        "auth_service.DeleteManyUserRequest_User": {
            "type": "object",
            "properties": {
                "client_type_id": {
                    "type": "string"
        ...
        "auth_service.DeleteSessionsByDeviceRequest": {
            "type": "object",
            "properties": {
                "client_type_id": {
                    "type": "string"
        ...
        "auth_service.ExpireSessionsRequest": {
            "type": "object",
            "properties": {
                "session_ids": {
                    "type": "array",
        ...
        "auth_service.GetSessionDevicesResponse": {
            "type": "object",
            "properties": {
                "sessions": {
                    "type": "array",
        ...
        "auth_service.GetSessionListResponse": {
            "type": "object",
            "properties": {
                "count": {
                    "type": "integer"
        ...
        "auth_service.ListClientTokenResponse": {
            "type": "object",
            "properties": {
                "client_tokens": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/auth_service.ClientIdToken"
                    }
                },
                "count": {
                    "type": "integer"
        ...
        "auth_service.RegisterCompanyRequest": {
            ...
            "properties": {
                ...
                "googleToken": {
                    "$ref": "#/definitions/auth_service.RegisterCompanyRequest_GoogleToken"
                },
                "is_ugen": {
                    "type": "boolean"
                },
        ...
        "auth_service.RegisterCompanyRequest_GoogleToken": {
            "type": "object",
            "properties": {
                "access_token": {
                    "type": "string"
        ...
        "auth_service.V2UserResetPasswordRequest": {
            "type": "object",
            "properties": {
                "client_type_id": {
                    "type": "string"
        ...
        "company_service.Fare": {
            ...
            "properties": {
                ...
                "fare_item_prices": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/company_service.FareItemPrice"
                    }
                },
                "id": {
                    "type": "string"
        ...
        "company_service.FareItemPrice": {
            ...
            "properties": {
                ...
                "fare_item": {
                    "$ref": "#/definitions/company_service.FareItem"
                },
                "fare_item_id": {
                    "type": "string"
                },
