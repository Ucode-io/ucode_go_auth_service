...
const docTemplate = `{
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/ucode_ucode_go_auth_service_genproto_auth_service.V2ResetPasswordRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "ucode_ucode_go_auth_service_genproto_auth_service.V2ResetPasswordRequest": {
            "type": "object",
            "properties": {
                "password": {
                    "type": "string"
