...
const (
	NotificationService_GetSingleNotification_FullMethodName   = "/notification_service.NotificationService/GetSingleNotification"
	NotificationService_GetAllNotification_FullMethodName      = "/notification_service.NotificationService/GetAllNotification"
	NotificationService_CreateNotification_FullMethodName      = "/notification_service.NotificationService/CreateNotification"
	NotificationService_UpdateNotification_FullMethodName      = "/notification_service.NotificationService/UpdateNotification"
	NotificationService_DeleteNotification_FullMethodName      = "/notification_service.NotificationService/DeleteNotification"
	NotificationService_CreateNotificationUsers_FullMethodName = "/notification_service.NotificationService/CreateNotificationUsers"
	NotificationService_CreateUserToken_FullMethodName         = "/notification_service.NotificationService/CreateUserToken"
	NotificationService_GetListUserToken_FullMethodName        = "/notification_service.NotificationService/GetListUserToken"
	NotificationService_DeleteUserToken_FullMethodName         = "/notification_service.NotificationService/DeleteUserToken"
)
...
func (c *notificationServiceClient) GetSingleNotification(ctx context.Context, in *GetSingleNotificationRequest, opts ...grpc.CallOption) (*Notification, error) {
	...
	err := c.cc.Invoke(ctx, NotificationService_GetSingleNotification_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *notificationServiceClient) GetAllNotification(ctx context.Context, in *GetAllNotificationsRequest, opts ...grpc.CallOption) (*GetAllNotificationsResponse, error) {
	...
	err := c.cc.Invoke(ctx, NotificationService_GetAllNotification_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *notificationServiceClient) CreateNotificationUsers(ctx context.Context, in *CreateNotificationManyUserRequest, opts ...grpc.CallOption) (*NotificationUsers, error) {
	...
	err := c.cc.Invoke(ctx, NotificationService_CreateNotificationUsers_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *notificationServiceClient) CreateUserToken(ctx context.Context, in *CreateUserTokenRequest, opts ...grpc.CallOption) (*CreateUserTokenResponse, error) {
	...
	err := c.cc.Invoke(ctx, NotificationService_CreateUserToken_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *notificationServiceClient) GetListUserToken(ctx context.Context, in *GetListUserTokenRequest, opts ...grpc.CallOption) (*ListUserToken, error) {
	...
	err := c.cc.Invoke(ctx, NotificationService_GetListUserToken_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *notificationServiceClient) DeleteUserToken(ctx context.Context, in *DeleteUserTokenRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, NotificationService_DeleteUserToken_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _NotificationService_GetSingleNotification_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: NotificationService_GetSingleNotification_FullMethodName,
	}
...
func _NotificationService_GetAllNotification_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: NotificationService_GetAllNotification_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _NotificationService_CreateNotificationUsers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: NotificationService_CreateNotificationUsers_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _NotificationService_CreateUserToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: NotificationService_CreateUserToken_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _NotificationService_GetListUserToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: NotificationService_GetListUserToken_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _NotificationService_DeleteUserToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: NotificationService_DeleteUserToken_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
