...
func (c *pingServiceClient) Ping(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*PongResponse, error) {
	out := new(PongResponse)
	err := c.cc.Invoke(ctx, "/ping_service.PingService/Ping", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedPingServiceServer) Ping(context.Context, *emptypb.Empty) (*PongResponse, error) {
...
func _PingService_Ping_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ping_service.PingService/Ping",
	}
...
var PingService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "ping_service.PingService",
