...
const (
	RunService_RunScenario_FullMethodName = "/scenario_service.RunService/RunScenario"
)
...
func (c *runServiceClient) RunScenario(ctx context.Context, in *RunScenarioRequest, opts ...grpc.CallOption) (*RunScenarioResponse, error) {
	out := new(RunScenarioResponse)
	err := c.cc.Invoke(ctx, RunService_RunScenario_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedRunServiceServer) RunScenario(context.Context, *RunScenarioRequest) (*RunScenarioResponse, error) {
...
func _RunService_RunScenario_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RunScenarioRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RunServiceServer).RunScenario(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RunService_RunScenario_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RunServiceServer).RunScenario(ctx, req.(*RunScenarioRequest))
	}
...
var RunService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "scenario_service.RunService",
	HandlerType: (*RunServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "RunScenario",
			Handler:    _RunService_RunScenario_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "run_service.proto",
}
