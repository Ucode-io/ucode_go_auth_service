...
func (c *payzeServiceClient) GeneratePayzeLink(ctx context.Context, in *PayzeLinkRequest, opts ...grpc.CallOption) (*PayzeLinkResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/integration_service.PayzeService/GeneratePayzeLink", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *payzeServiceClient) GeneratePayzeLinkSvod(ctx context.Context, in *PayzeLinkRequestSvod, opts ...grpc.CallOption) (*PayzeLinkResponse, error) {
	out := new(PayzeLinkResponse)
	err := c.cc.Invoke(ctx, "/integration_service.PayzeService/GeneratePayzeLinkSvod", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _PayzeService_GeneratePayzeLink_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/integration_service.PayzeService/GeneratePayzeLink",
	}
...
func _PayzeService_GeneratePayzeLinkSvod_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PayzeLinkRequestSvod)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PayzeServiceServer).GeneratePayzeLinkSvod(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/integration_service.PayzeService/GeneratePayzeLinkSvod",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PayzeServiceServer).GeneratePayzeLinkSvod(ctx, req.(*PayzeLinkRequestSvod))
	}
	return interceptor(ctx, in, info, handler)
}
