...
type SubcategoryServiceClient interface {
	...
	DeleteByCategoryID(ctx context.Context, in *SubcategoryPrimaryKey, opts ...grpc.CallOption) (*empty.Empty, error)
}
...
func (c *subcategoryServiceClient) DeleteByCategoryID(ctx context.Context, in *SubcategoryPrimaryKey, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
type SubcategoryServiceServer interface {
	...
	DeleteByCategoryID(context.Context, *SubcategoryPrimaryKey) (*empty.Empty, error)
...
func (UnimplementedSubcategoryServiceServer) DeleteByCategoryID(context.Context, *SubcategoryPrimaryKey) (*empty.Empty, error) {
