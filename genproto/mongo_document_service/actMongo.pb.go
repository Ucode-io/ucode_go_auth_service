...
type MongoActDoc struct {
	...
	ActNo   string `protobuf:"bytes,1,opt,name=ActNo,proto3" json:"ActNo"`
	ActDate string `protobuf:"bytes,2,opt,name=ActDate,proto3" json:"ActDate"`
	ActText string `protobuf:"bytes,3,opt,name=ActText,proto3" json:"ActText"`
}
...
type MongoProduct struct {
	...
	BarCode            *wrapperspb.StringValue `protobuf:"bytes,4,opt,name=BarCode,proto3" json:"BarCode"`
	Name               string                  `protobuf:"bytes,5,opt,name=Name,proto3" json:"Name"`
	MeasureId          string                  `protobuf:"bytes,6,opt,name=MeasureId,proto3" json:"MeasureId"`
	Count              int32                   `protobuf:"varint,7,opt,name=Count,proto3" json:"Count"`
	Summa              float32                 `protobuf:"fixed32,8,opt,name=Summa,proto3" json:"Summa"`
	DeliverySum        float32                 `protobuf:"fixed32,9,opt,name=DeliverySum,proto3" json:"DeliverySum"`
	VatRate            int32                   `protobuf:"varint,10,opt,name=VatRate,proto3" json:"VatRate"`
	VatSum             float32                 `protobuf:"fixed32,11,opt,name=VatSum,proto3" json:"VatSum"`
	DeliverySumWithVat float32                 `protobuf:"fixed32,12,opt,name=DeliverySumWithVat,proto3" json:"DeliverySumWithVat"`
	WithoutVat         bool                    `protobuf:"varint,13,opt,name=WithoutVat,proto3" json:"WithoutVat"`
	ActId              string                  `protobuf:"bytes,14,opt,name=ActId,proto3" json:"ActId"`
	TotalSum           float32                 `protobuf:"fixed32,15,opt,name=TotalSum,proto3" json:"TotalSum"`
	Index              int64                   `protobuf:"varint,16,opt,name=Index,proto3" json:"Index"`
	MeasureName        string                  `protobuf:"bytes,17,opt,name=MeasureName,proto3" json:"MeasureName"`
}
...
type MongoProductList struct {
	...
	ActProductId string          `protobuf:"bytes,1,opt,name=ActProductId,proto3" json:"ActProductId"`
	Tin          string          `protobuf:"bytes,2,opt,name=Tin,proto3" json:"Tin"`
	Products     []*MongoProduct `protobuf:"bytes,3,rep,name=Products,proto3" json:"Products"`
}
...
type MongoAct struct {
	...
	ActId            string            `protobuf:"bytes,1,opt,name=ActId,proto3" json:"ActId"`
	ActDoc           *MongoActDoc      `protobuf:"bytes,2,opt,name=ActDoc,proto3" json:"ActDoc"`
	ContractDoc      *ContractDoc      `protobuf:"bytes,3,opt,name=ContractDoc,proto3" json:"ContractDoc"`
	SellerTin        string            `protobuf:"bytes,4,opt,name=SellerTin,proto3" json:"SellerTin"`
	SellerName       string            `protobuf:"bytes,5,opt,name=SellerName,proto3" json:"SellerName"`
	SellerBranchCode string            `protobuf:"bytes,6,opt,name=SellerBranchCode,proto3" json:"SellerBranchCode"`
	SellerBranchName string            `protobuf:"bytes,7,opt,name=SellerBranchName,proto3" json:"SellerBranchName"`
	BuyerTin         string            `protobuf:"bytes,8,opt,name=BuyerTin,proto3" json:"BuyerTin"`
	BuyerName        string            `protobuf:"bytes,9,opt,name=BuyerName,proto3" json:"BuyerName"`
	BuyerBranchCode  string            `protobuf:"bytes,10,opt,name=BuyerBranchCode,proto3" json:"BuyerBranchCode"`
	BuyerBranchName  string            `protobuf:"bytes,11,opt,name=BuyerBranchName,proto3" json:"BuyerBranchName"`
	ProductList      *MongoProductList `protobuf:"bytes,12,opt,name=ProductList,proto3" json:"ProductList"`
	Notes            string            `protobuf:"bytes,13,opt,name=Notes,proto3" json:"Notes"`
	TotalDeliverySum float32           `protobuf:"fixed32,14,opt,name=TotalDeliverySum,proto3" json:"TotalDeliverySum"`
	TotalValue       float32           `protobuf:"fixed32,15,opt,name=TotalValue,proto3" json:"TotalValue"`
}
...
type MongoActResponse struct {
	...
	Act        *MongoAct `protobuf:"bytes,1,opt,name=Act,proto3" json:"Act"`
...
type MongoActUpsertRequest struct {
	...
	BuyerBranchName  string            `protobuf:"bytes,11,opt,name=BuyerBranchName,proto3" json:"BuyerBranchName"`
	ProductList      *MongoProductList `protobuf:"bytes,12,opt,name=ProductList,proto3" json:"ProductList"`
	Sign             string            `protobuf:"bytes,13,opt,name=Sign,proto3" json:"Sign"`
	Status           string            `protobuf:"bytes,14,opt,name=Status,proto3" json:"Status"`
	Notes            string            `protobuf:"bytes,15,opt,name=Notes,proto3" json:"Notes"`
	TotalDeliverySum float32           `protobuf:"fixed32,16,opt,name=TotalDeliverySum,proto3" json:"TotalDeliverySum"`
	TotalValue       float32           `protobuf:"fixed32,17,opt,name=TotalValue,proto3" json:"TotalValue"`
}
