...
type BCTable struct {
	...
	BuildingCalculationTableId  string              `protobuf:"bytes,1,opt,name=BuildingCalculationTableId,proto3" json:"BuildingCalculationTableId"`
	...
	ObjectName                  string              `protobuf:"bytes,4,opt,name=ObjectName,proto3" json:"ObjectName"`
	BuildingFacturaDoc          *BuildingFacturaDoc `protobuf:"bytes,5,opt,name=BuildingFacturaDoc,proto3" json:"BuildingFacturaDoc"`
	GeneralContractorTinOrPinfl string              `protobuf:"bytes,6,opt,name=GeneralContractorTinOrPinfl,proto3" json:"GeneralContractorTinOrPinfl"`
	CustomerTinOrPinfl          string              `protobuf:"bytes,7,opt,name=CustomerTinOrPinfl,proto3" json:"CustomerTinOrPinfl"`
	GeneralContractor           *Person             `protobuf:"bytes,8,opt,name=GeneralContractor,proto3" json:"GeneralContractor"`
	Customer                    *Person             `protobuf:"bytes,9,opt,name=Customer,proto3" json:"Customer"`
	Subcontractors              []*Subcontractor    `protobuf:"bytes,10,rep,name=Subcontractors,proto3" json:"Subcontractors"`
	Detailing                   *Detailing          `protobuf:"bytes,11,opt,name=Detailing,proto3" json:"Detailing"`
}
...
type BuildingCalculationTable struct {
	...
	BuildingCalculationTable *BCTable `protobuf:"bytes,1,opt,name=BuildingCalculationTable,proto3" json:"BuildingCalculationTable"`
	...
	PdfUz                    string   `protobuf:"bytes,7,opt,name=PdfUz,proto3" json:"PdfUz"`
	PdfRu                    string   `protobuf:"bytes,8,opt,name=PdfRu,proto3" json:"PdfRu"`
...
type Person struct {
	...
	Director   string `protobuf:"bytes,2,opt,name=Director,proto3" json:"Director"`
	Accountant string `protobuf:"bytes,3,opt,name=Accountant,proto3" json:"Accountant"`
	BranchCode string `protobuf:"bytes,4,opt,name=BranchCode,proto3" json:"BranchCode"`
	BranchName string `protobuf:"bytes,5,opt,name=BranchName,proto3" json:"BranchName"`
}
...
type Subcontractor struct {
	...
	TinOrPinfl string     `protobuf:"bytes,1,opt,name=TinOrPinfl,proto3" json:"TinOrPinfl"`
	Company    *Person    `protobuf:"bytes,2,opt,name=Company,proto3" json:"Company"`
	Detailing  *Detailing `protobuf:"bytes,3,opt,name=Detailing,proto3" json:"Detailing"`
...
type Detailing struct {
	...
	LaborCosts        *Material `protobuf:"bytes,1,opt,name=LaborCosts,proto3" json:"LaborCosts"`
	BuildingMaterials *Material `protobuf:"bytes,2,opt,name=BuildingMaterials,proto3" json:"BuildingMaterials"`
	Equipment         *Material `protobuf:"bytes,3,opt,name=Equipment,proto3" json:"Equipment"`
	Total             *Summary  `protobuf:"bytes,4,opt,name=Total,proto3" json:"Total"`
}
...
type Material struct {
	...
	Products []*ProductTable `protobuf:"bytes,1,rep,name=Products,proto3" json:"Products"`
	Summary  *Summary        `protobuf:"bytes,2,opt,name=Summary,proto3" json:"Summary"`
}
...
type ProductTable struct {
	...
	ProvidedByOffer         *Summa       `protobuf:"bytes,1,opt,name=ProvidedByOffer,proto3" json:"ProvidedByOffer"`
	FromStartOfConstruction *Summa       `protobuf:"bytes,2,opt,name=FromStartOfConstruction,proto3" json:"FromStartOfConstruction"`
	FromBeginningOfYear     *Summa       `protobuf:"bytes,3,opt,name=FromBeginningOfYear,proto3" json:"FromBeginningOfYear"`
	ForReportingMonth       *Summa       `protobuf:"bytes,4,opt,name=ForReportingMonth,proto3" json:"ForReportingMonth"`
	IncomingDoc             *SummaSeller `protobuf:"bytes,5,opt,name=IncomingDoc,proto3" json:"IncomingDoc"`
	OrdNo                   int64        `protobuf:"varint,6,opt,name=OrdNo,proto3" json:"OrdNo"`
	CatalogCode             string       `protobuf:"bytes,7,opt,name=CatalogCode,proto3" json:"CatalogCode"`
	CatalogName             string       `protobuf:"bytes,8,opt,name=CatalogName,proto3" json:"CatalogName"`
	MeasureId               int64        `protobuf:"varint,9,opt,name=MeasureId,proto3" json:"MeasureId"`
	MeasureName             string       `protobuf:"bytes,10,opt,name=MeasureName,proto3" json:"MeasureName"`
}
...
type SummaSeller struct {
	...
	Price            float32 `protobuf:"fixed32,2,opt,name=Price,proto3" json:"Price"`
	Total            float32 `protobuf:"fixed32,3,opt,name=Total,proto3" json:"Total"`
	SellerTinOrPinfl string  `protobuf:"bytes,4,opt,name=SellerTinOrPinfl,proto3" json:"SellerTinOrPinfl"`
	SellerName       string  `protobuf:"bytes,5,opt,name=SellerName,proto3" json:"SellerName"`
}
...
type Summary struct {
	...
	FromBeginningOfYear     *Summa `protobuf:"bytes,3,opt,name=FromBeginningOfYear,proto3" json:"FromBeginningOfYear"`
	ForReportingMonth       *Summa `protobuf:"bytes,4,opt,name=ForReportingMonth,proto3" json:"ForReportingMonth"`
	IncomingDoc             *Summa `protobuf:"bytes,5,opt,name=IncomingDoc,proto3" json:"IncomingDoc"`
}
