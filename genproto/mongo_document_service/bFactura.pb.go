...
type BFactura struct {
	...
	BuildingFacturaId             string                           `protobuf:"bytes,1,opt,name=BuildingFacturaId,proto3" json:"BuildingFacturaId"`
	GeneralContractorTinOrPinfl   string                           `protobuf:"bytes,2,opt,name=GeneralContractorTinOrPinfl,proto3" json:"GeneralContractorTinOrPinfl"`
	CustomerTinOrPinfl            string                           `protobuf:"bytes,3,opt,name=CustomerTinOrPinfl,proto3" json:"CustomerTinOrPinfl"`
	GeneralContractor             *Client                          `protobuf:"bytes,4,opt,name=GeneralContractor,proto3" json:"GeneralContractor"`
	Customer                      *Client                          `protobuf:"bytes,5,opt,name=Customer,proto3" json:"Customer"`
	TechnicalManagerFullName      string                           `protobuf:"bytes,6,opt,name=TechnicalManagerFullName,proto3" json:"TechnicalManagerFullName"`
	TechnicalManagerPinfl         string                           `protobuf:"bytes,7,opt,name=TechnicalManagerPinfl,proto3" json:"TechnicalManagerPinfl"`
	SubcontractorBuildingFacturas []*SubcontractorBuildingFacturas `protobuf:"bytes,8,rep,name=SubcontractorBuildingFacturas,proto3" json:"SubcontractorBuildingFacturas"`
	BuildingFacturaDoc            *BuildingFacturaDoc              `protobuf:"bytes,9,opt,name=BuildingFacturaDoc,proto3" json:"BuildingFacturaDoc"`
	ContractDoc                   *ContractDoc                     `protobuf:"bytes,10,opt,name=ContractDoc,proto3" json:"ContractDoc"`
	ReportingPeriodDoc            *ReportingPeriodDoc              `protobuf:"bytes,11,opt,name=ReportingPeriodDoc,proto3" json:"ReportingPeriodDoc"`
	BuildingObjectDoc             *BuildingObjectDoc               `protobuf:"bytes,12,opt,name=BuildingObjectDoc,proto3" json:"BuildingObjectDoc"`
	WorkingDesign                 *WorkingDesign                   `protobuf:"bytes,13,opt,name=WorkingDesign,proto3" json:"WorkingDesign"`
	ConstructionWork              *WorkingDesign                   `protobuf:"bytes,14,opt,name=ConstructionWork,proto3" json:"ConstructionWork"`
	Equipment                     *WorkingDesign                   `protobuf:"bytes,15,opt,name=Equipment,proto3" json:"Equipment"`
	Total                         *Total                           `protobuf:"bytes,16,opt,name=Total,proto3" json:"Total"`
	TotalPrice                    int32                            `protobuf:"varint,17,opt,name=TotalPrice,proto3" json:"TotalPrice"`
}
...
type BuildingFactura struct {
	...
	BuildingFactura *BFactura `protobuf:"bytes,1,opt,name=BuildingFactura,proto3" json:"BuildingFactura"`
	Status          string    `protobuf:"bytes,2,opt,name=Status,proto3" json:"Status"`
	Sign            string    `protobuf:"bytes,3,opt,name=Sign,proto3" json:"Sign"`
	PageStatus      string    `protobuf:"bytes,4,opt,name=PageStatus,proto3" json:"PageStatus"`
	ContractPdfUz   string    `protobuf:"bytes,5,opt,name=ContractPdfUz,proto3" json:"ContractPdfUz"`
	ContractPdfRu   string    `protobuf:"bytes,6,opt,name=ContractPdfRu,proto3" json:"ContractPdfRu"`
...
type Client struct {
	...
	BankId       string                 `protobuf:"bytes,3,opt,name=BankId,proto3" json:"BankId"`
	...
	WorkPhone    string                 `protobuf:"bytes,6,opt,name=WorkPhone,proto3" json:"WorkPhone"`
	Oked         string                 `protobuf:"bytes,7,opt,name=Oked,proto3" json:"Oked"`
	DistrictId   string                 `protobuf:"bytes,8,opt,name=DistrictId,proto3" json:"DistrictId"`
	Director     string                 `protobuf:"bytes,9,opt,name=Director,proto3" json:"Director"`
	Accountant   string                 `protobuf:"bytes,10,opt,name=Accountant,proto3" json:"Accountant"`
	VatRegCode   string                 `protobuf:"bytes,11,opt,name=VatRegCode,proto3" json:"VatRegCode"`
	VatRegStatus *wrapperspb.Int32Value `protobuf:"bytes,12,opt,name=VatRegStatus,proto3" json:"VatRegStatus"`
	BranchCode   string                 `protobuf:"bytes,13,opt,name=BranchCode,proto3" json:"BranchCode"`
	BranchName   string                 `protobuf:"bytes,14,opt,name=BranchName,proto3" json:"BranchName"`
	TaxGap       *wrapperspb.FloatValue `protobuf:"bytes,15,opt,name=TaxGap,proto3" json:"TaxGap"`
}
...
type SubcontractorBuildingFacturas struct {
	...
	BuildingFacturaId   string `protobuf:"bytes,1,opt,name=BuildingFacturaId,proto3" json:"BuildingFacturaId"`
	BuildingFacturaNo   string `protobuf:"bytes,2,opt,name=BuildingFacturaNo,proto3" json:"BuildingFacturaNo"`
	BuildingFacturaDate string `protobuf:"bytes,3,opt,name=BuildingFacturaDate,proto3" json:"BuildingFacturaDate"`
}
...
type ReportingPeriodDoc struct {
	...
	ReportingPeriodFrom string `protobuf:"bytes,1,opt,name=ReportingPeriodFrom,proto3" json:"ReportingPeriodFrom"`
	ReportingPeriodTo   string `protobuf:"bytes,2,opt,name=ReportingPeriodTo,proto3" json:"ReportingPeriodTo"`
}
...
type BuildingObjectDoc struct {
	...
	ObjectId      string `protobuf:"bytes,1,opt,name=ObjectId,proto3" json:"ObjectId"`
	ObjectName    string `protobuf:"bytes,2,opt,name=ObjectName,proto3" json:"ObjectName"`
	ObjectAddress string `protobuf:"bytes,3,opt,name=ObjectAddress,proto3" json:"ObjectAddress"`
}
...
type WorkingDesign struct {
	...
	Works   []*Works  `protobuf:"bytes,1,rep,name=Works,proto3" json:"Works"`
	Summary *SummaryB `protobuf:"bytes,2,opt,name=Summary,proto3" json:"Summary"`
}
...
type Works struct {
	...
	WorkloadTotal           float32 `protobuf:"fixed32,1,opt,name=WorkloadTotal,proto3" json:"WorkloadTotal"`
	WorkloadCurrentYear     int32   `protobuf:"varint,2,opt,name=WorkloadCurrentYear,proto3" json:"WorkloadCurrentYear"`
	PriceTotal              float32 `protobuf:"fixed32,3,opt,name=PriceTotal,proto3" json:"PriceTotal"`
	PriceCurrentYear        int32   `protobuf:"varint,4,opt,name=PriceCurrentYear,proto3" json:"PriceCurrentYear"`
	FromStartOfConstruction *Report `protobuf:"bytes,5,opt,name=FromStartOfConstruction,proto3" json:"FromStartOfConstruction"`
	FromBeginningOfYear     *Report `protobuf:"bytes,6,opt,name=FromBeginningOfYear,proto3" json:"FromBeginningOfYear"`
	ForReportingMonth       *Report `protobuf:"bytes,7,opt,name=ForReportingMonth,proto3" json:"ForReportingMonth"`
	OrdNo                   int32   `protobuf:"varint,8,opt,name=OrdNo,proto3" json:"OrdNo"`
	NormativeNumber         string  `protobuf:"bytes,9,opt,name=NormativeNumber,proto3" json:"NormativeNumber"`
	Name                    string  `protobuf:"bytes,10,opt,name=Name,proto3" json:"Name"`
	MeasureId               int32   `protobuf:"varint,11,opt,name=MeasureId,proto3" json:"MeasureId"`
	MeasureName             string  `protobuf:"bytes,12,opt,name=MeasureName,proto3" json:"MeasureName"`
}
...
type Report struct {
	...
	Physical   float32 `protobuf:"fixed32,1,opt,name=Physical,proto3" json:"Physical"`
	Percentage float32 `protobuf:"fixed32,2,opt,name=Percentage,proto3" json:"Percentage"`
...
type SummaryB struct {
	...
	Total    *Total `protobuf:"bytes,1,opt,name=Total,proto3" json:"Total"`
	Vat      *Vat   `protobuf:"bytes,2,opt,name=Vat,proto3" json:"Vat"`
	TotalVat *Vat   `protobuf:"bytes,3,opt,name=TotalVat,proto3" json:"TotalVat"`
}
...
type Total struct {
	...
	WorkloadTotal           float32 `protobuf:"fixed32,1,opt,name=WorkloadTotal,proto3" json:"WorkloadTotal"`
	WorkloadCurrentYear     float32 `protobuf:"fixed32,2,opt,name=WorkloadCurrentYear,proto3" json:"WorkloadCurrentYear"`
	PriceTotal              float32 `protobuf:"fixed32,3,opt,name=PriceTotal,proto3" json:"PriceTotal"`
	PriceCurrentYear        float32 `protobuf:"fixed32,4,opt,name=PriceCurrentYear,proto3" json:"PriceCurrentYear"`
	FromStartOfConstruction *Report `protobuf:"bytes,5,opt,name=FromStartOfConstruction,proto3" json:"FromStartOfConstruction"`
	FromBeginningOfYear     *Report `protobuf:"bytes,6,opt,name=FromBeginningOfYear,proto3" json:"FromBeginningOfYear"`
	ForReportingMonth       *Report `protobuf:"bytes,7,opt,name=ForReportingMonth,proto3" json:"ForReportingMonth"`
}
...
type Vat struct {
	...
	PriceTotal              float32 `protobuf:"fixed32,1,opt,name=PriceTotal,proto3" json:"PriceTotal"`
	PriceCurrentYear        float32 `protobuf:"fixed32,2,opt,name=PriceCurrentYear,proto3" json:"PriceCurrentYear"`
	FromStartOfConstruction float32 `protobuf:"fixed32,3,opt,name=FromStartOfConstruction,proto3" json:"FromStartOfConstruction"`
	FromBeginningOfYear     float32 `protobuf:"fixed32,4,opt,name=FromBeginningOfYear,proto3" json:"FromBeginningOfYear"`
	ForReportingMonth       float32 `protobuf:"fixed32,5,opt,name=ForReportingMonth,proto3" json:"ForReportingMonth"`
}
