...
type Client struct {
	...
	VatRegStatus *wrappers.Int32Value `protobuf:"bytes,12,opt,name=VatRegStatus,proto3" json:"VatRegStatus,omitempty"`
	...
	TaxGap       *wrappers.FloatValue `protobuf:"bytes,15,opt,name=TaxGap,proto3" json:"TaxGap,omitempty"`
}
...
func (x *Client) GetVatRegStatus() *wrappers.Int32Value {
	if x != nil {
...
func (x *Client) GetTaxGap() *wrappers.FloatValue {
	if x != nil {
		return x.TaxGap
	}
	return nil
