...
type ContractDocC struct {
	...
	ContractName       string `protobuf:"bytes,1,opt,name=ContractName,proto3" json:"ContractName"`
	ContractNo         string `protobuf:"bytes,2,opt,name=ContractNo,proto3" json:"ContractNo"`
	ContractDate       string `protobuf:"bytes,3,opt,name=ContractDate,proto3" json:"ContractDate"`
	ContractExpireDate string `protobuf:"bytes,4,opt,name=ContractExpireDate,proto3" json:"ContractExpireDate"`
	ContractPlace      string `protobuf:"bytes,5,opt,name=ContractPlace,proto3" json:"ContractPlace"`
}
...
type ContractGetResp struct {
	...
	HtmlUz string `protobuf:"bytes,1,opt,name=HtmlUz,proto3" json:"HtmlUz"`
	HtmlRu string `protobuf:"bytes,2,opt,name=HtmlRu,proto3" json:"HtmlRu"`
...
type ContractM struct {
	...
	HasVat      bool               `protobuf:"varint,2,opt,name=HasVat,proto3" json:"HasVat"`
	ContractDoc *ContractDocC      `protobuf:"bytes,3,opt,name=ContractDoc,proto3" json:"ContractDoc"`
	Owner       *ContractPerson    `protobuf:"bytes,4,opt,name=Owner,proto3" json:"Owner"`
	Clients     []*ContractPerson  `protobuf:"bytes,5,rep,name=Clients,proto3" json:"Clients"`
	Products    []*ContractProduct `protobuf:"bytes,6,rep,name=Products,proto3" json:"Products"`
	Parts       []*Part            `protobuf:"bytes,7,rep,name=Parts,proto3" json:"Parts"`
}
...
type Contract struct {
	...
	Contract   *ContractM `protobuf:"bytes,1,opt,name=Contract,proto3" json:"Contract"`
...
type ContractProduct struct {
	...
	ContractId         string  `protobuf:"bytes,14,opt,name=ContractId,proto3" json:"ContractId"`
	TotalSum           float32 `protobuf:"fixed32,15,opt,name=TotalSum,proto3" json:"TotalSum"`
	Index              int32   `protobuf:"varint,16,opt,name=Index,proto3" json:"Index"`
}
...
type ContractPerson struct {
	...
	WorkPhone  string `protobuf:"bytes,4,opt,name=WorkPhone,proto3" json:"WorkPhone"`
	Mobile     string `protobuf:"bytes,5,opt,name=Mobile,proto3" json:"Mobile"`
	Fax        string `protobuf:"bytes,6,opt,name=Fax,proto3" json:"Fax"`
	...
	BankId     string `protobuf:"bytes,9,opt,name=BankId,proto3" json:"BankId"`
	FizTin     string `protobuf:"bytes,10,opt,name=FizTin,proto3" json:"FizTin"`
	Fio        string `protobuf:"bytes,11,opt,name=Fio,proto3" json:"Fio"`
	BranchCode string `protobuf:"bytes,12,opt,name=BranchCode,proto3" json:"BranchCode"`
	BranchName string `protobuf:"bytes,13,opt,name=BranchName,proto3" json:"BranchName"`
	ContractId string `protobuf:"bytes,14,opt,name=ContractId,proto3" json:"ContractId"`
	Status     bool   `protobuf:"varint,15,opt,name=Status,proto3" json:"Status"`
}
...
type Part struct {
	...
	ContractId string `protobuf:"bytes,4,opt,name=ContractId,proto3" json:"ContractId"`
}
