...
type DocumentMon struct {
	...
	DocumentDoc *DocumentDoc `protobuf:"bytes,1,opt,name=DocumentDoc,proto3" json:"DocumentDoc"`
	Contract    *ContractDoc `protobuf:"bytes,2,opt,name=Contract,proto3" json:"Contract"`
	DocumentId  string       `protobuf:"bytes,3,opt,name=DocumentId,proto3" json:"DocumentId"`
	Owner       *Company     `protobuf:"bytes,4,opt,name=Owner,proto3" json:"Owner"`
	Partner     *Company     `protobuf:"bytes,5,opt,name=Partner,proto3" json:"Partner"`
	Info        string       `protobuf:"bytes,6,opt,name=Info,proto3" json:"Info"`
	File        string       `protobuf:"bytes,7,opt,name=File,proto3" json:"File"`
}
...
type Document struct {
	...
	Document  *DocumentMon `protobuf:"bytes,1,opt,name=Document,proto3" json:"Document"`
	Status    string       `protobuf:"bytes,2,opt,name=Status,proto3" json:"Status"`
	Sign      string       `protobuf:"bytes,3,opt,name=Sign,proto3" json:"Sign"`
	UzPdfUrl  string       `protobuf:"bytes,4,opt,name=UzPdfUrl,proto3" json:"UzPdfUrl"`
	RuPdfUrl  string       `protobuf:"bytes,5,opt,name=RuPdfUrl,proto3" json:"RuPdfUrl"`
	...
	HtmlUz    string       `protobuf:"bytes,8,opt,name=HtmlUz,proto3" json:"HtmlUz"`
	HtmlRu    string       `protobuf:"bytes,9,opt,name=HtmlRu,proto3" json:"HtmlRu"`
}
...
type DocumentDoc struct {
	...
	DocumentNo   string `protobuf:"bytes,1,opt,name=DocumentNo,proto3" json:"DocumentNo"`
	DocumentDate string `protobuf:"bytes,2,opt,name=DocumentDate,proto3" json:"DocumentDate"`
	DocumentName string `protobuf:"bytes,3,opt,name=DocumentName,proto3" json:"DocumentName"`
}
...
type Company struct {
	...
	Inn      string `protobuf:"bytes,1,opt,name=Inn,proto3" json:"Inn"`
	Name     string `protobuf:"bytes,2,opt,name=Name,proto3" json:"Name"`
	Location string `protobuf:"bytes,3,opt,name=Location,proto3" json:"Location"`
	WithVat  string `protobuf:"bytes,4,opt,name=WithVat,proto3" json:"WithVat"`
}
