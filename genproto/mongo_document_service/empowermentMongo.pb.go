...
type EmpowermentMongo struct {
	...
	EmpowermentId  string                  `protobuf:"bytes,1,opt,name=EmpowermentId,proto3" json:"EmpowermentId"`
	EmpowermentDoc *EmpowermentDoc         `protobuf:"bytes,2,opt,name=EmpowermentDoc,proto3" json:"EmpowermentDoc"`
	ContractDoc    *ContractDoc            `protobuf:"bytes,3,opt,name=ContractDoc,proto3" json:"ContractDoc"`
	Agent          *AgentEmpowerment       `protobuf:"bytes,4,opt,name=Agent,proto3" json:"Agent"`
	SellerTin      string                  `protobuf:"bytes,5,opt,name=SellerTin,proto3" json:"SellerTin"`
	BuyerTin       string                  `protobuf:"bytes,6,opt,name=BuyerTin,proto3" json:"BuyerTin"`
	Seller         *CompanyEmpowerment     `protobuf:"bytes,7,opt,name=Seller,proto3" json:"Seller"`
	Buyer          *CompanyEmpowerment     `protobuf:"bytes,8,opt,name=Buyer,proto3" json:"Buyer"`
	ProductList    *ProductListEmpowerment `protobuf:"bytes,9,opt,name=ProductList,proto3" json:"ProductList"`
}
...
type Empowerment struct {
	...
	Empowerment *EmpowermentMongo `protobuf:"bytes,1,opt,name=Empowerment,proto3" json:"Empowerment"`
	...
	PdfUrlUz    string            `protobuf:"bytes,6,opt,name=PdfUrlUz,proto3" json:"PdfUrlUz"`
	PdfUrlRu    string            `protobuf:"bytes,7,opt,name=PdfUrlRu,proto3" json:"PdfUrlRu"`
	PageStatus  string            `protobuf:"bytes,8,opt,name=PageStatus,proto3" json:"PageStatus"`
...
type EmpowermentDoc struct {
	...
	EmpowermentDateOfExpire string `protobuf:"bytes,3,opt,name=EmpowermentDateOfExpire,proto3" json:"EmpowermentDateOfExpire"`
}
...
type AgentEmpowerment struct {
	...
	AgentEmpowermentId string               `protobuf:"bytes,1,opt,name=AgentEmpowermentId,proto3" json:"AgentEmpowermentId"`
	AgentTin           string               `protobuf:"bytes,2,opt,name=AgentTin,proto3" json:"AgentTin"`
	JobTitle           string               `protobuf:"bytes,3,opt,name=JobTitle,proto3" json:"JobTitle"`
	Fio                string               `protobuf:"bytes,4,opt,name=Fio,proto3" json:"Fio"`
	Passport           *PassportEmpowerment `protobuf:"bytes,5,opt,name=Passport,proto3" json:"Passport"`
}
...
type PassportEmpowerment struct {
	...
	DateOfIssue string `protobuf:"bytes,2,opt,name=DateOfIssue,proto3" json:"DateOfIssue"`
	IssuedBy    string `protobuf:"bytes,3,opt,name=IssuedBy,proto3" json:"IssuedBy"`
}
...
type CompanyEmpowerment struct {
	...
	BranchCode string `protobuf:"bytes,11,opt,name=BranchCode,proto3" json:"BranchCode"`
	BranchName string `protobuf:"bytes,12,opt,name=BranchName,proto3" json:"BranchName"`
...
type ProductListEmpowerment struct {
	...
	EmpowermentProductId string                `protobuf:"bytes,1,opt,name=EmpowermentProductId,proto3" json:"EmpowermentProductId"`
	Tin                  string                `protobuf:"bytes,2,opt,name=Tin,proto3" json:"Tin"`
	Products             []*ProductEmpowerment `protobuf:"bytes,3,rep,name=Products,proto3" json:"Products"`
}
...
type ProductEmpowerment struct {
	...
	OrdNo              string `protobuf:"bytes,1,opt,name=OrdNo,proto3" json:"OrdNo"`
	CatalogCode        string `protobuf:"bytes,2,opt,name=CatalogCode,proto3" json:"CatalogCode"`
	CatalogName        string `protobuf:"bytes,3,opt,name=CatalogName,proto3" json:"CatalogName"`
	BarCode            string `protobuf:"bytes,4,opt,name=BarCode,proto3" json:"BarCode"`
	Name               string `protobuf:"bytes,5,opt,name=Name,proto3" json:"Name"`
	MeasureId          string `protobuf:"bytes,6,opt,name=MeasureId,proto3" json:"MeasureId"`
	Count              string `protobuf:"bytes,7,opt,name=Count,proto3" json:"Count"`
	DeliverySum        string `protobuf:"bytes,8,opt,name=DeliverySum,proto3" json:"DeliverySum"`
	VatRate            string `protobuf:"bytes,9,opt,name=VatRate,proto3" json:"VatRate"`
	VatSum             string `protobuf:"bytes,10,opt,name=VatSum,proto3" json:"VatSum"`
	DeliverySumWithVat string `protobuf:"bytes,11,opt,name=DeliverySumWithVat,proto3" json:"DeliverySumWithVat"`
	WithoutVat         bool   `protobuf:"varint,12,opt,name=WithoutVat,proto3" json:"WithoutVat"`
	MeasureName        string `protobuf:"bytes,13,opt,name=MeasureName,proto3" json:"MeasureName"`
}
