...
type MobileServiceClient interface {
	Create(ctx context.Context, in *Mobile, opts ...grpc.CallOption) (*empty.Empty, error)
	...
	Update(ctx context.Context, in *Mobile, opts ...grpc.CallOption) (*empty.Empty, error)
}
...
func (c *mobileServiceClient) Create(ctx context.Context, in *Mobile, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
func (c *mobileServiceClient) Delete(ctx context.Context, in *ById, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
func (c *mobileServiceClient) Update(ctx context.Context, in *Mobile, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
type MobileServiceServer interface {
	Create(context.Context, *Mobile) (*empty.Empty, error)
	...
	Update(context.Context, *Mobile) (*empty.Empty, error)
...
func (UnimplementedMobileServiceServer) Create(context.Context, *Mobile) (*empty.Empty, error) {
...
func (UnimplementedMobileServiceServer) Delete(context.Context, *ById) (*empty.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Delete not implemented")
}
func (UnimplementedMobileServiceServer) Update(context.Context, *Mobile) (*empty.Empty, error) {
