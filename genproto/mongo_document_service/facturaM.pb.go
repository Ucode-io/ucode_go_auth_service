...
type FacturaProducts struct {
	...
	LgotaId                *wrappers.Int32Value `protobuf:"bytes,25,opt,name=LgotaId,proto3" json:"LgotaId,omitempty"`
	CommittentVatRegStatus *wrappers.Int32Value `protobuf:"bytes,26,opt,name=CommittentVatRegStatus,proto3" json:"CommittentVatRegStatus,omitempty"`
...
func (x *FacturaProducts) GetLgotaId() *wrappers.Int32Value {
	if x != nil {
		return x.LgotaId
	}
	return nil
...
func (x *FacturaProducts) GetCommittentVatRegStatus() *wrappers.Int32Value {
	if x != nil {
