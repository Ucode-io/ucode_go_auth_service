...
type WebPageServiceClient interface {
	...
	DeleteWebPage(ctx context.Context, in *DeleteWebPageReq, opts ...grpc.CallOption) (*empty.Empty, error)
	RevertWebPage(ctx context.Context, in *RevertWebPageReq, opts ...grpc.CallOption) (*WebPage, error)
	CreateManyWebPage(ctx context.Context, in *ManyVersions, opts ...grpc.CallOption) (*empty.Empty, error)
...
func (c *webPageServiceClient) DeleteWebPage(ctx context.Context, in *DeleteWebPageReq, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
func (c *webPageServiceClient) CreateManyWebPage(ctx context.Context, in *ManyVersions, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
type WebPageServiceServer interface {
	...
	DeleteWebPage(context.Context, *DeleteWebPageReq) (*empty.Empty, error)
	RevertWebPage(context.Context, *RevertWebPageReq) (*WebPage, error)
	CreateManyWebPage(context.Context, *ManyVersions) (*empty.Empty, error)
...
func (UnimplementedWebPageServiceServer) DeleteWebPage(context.Context, *DeleteWebPageReq) (*empty.Empty, error) {
...
func (UnimplementedWebPageServiceServer) CreateManyWebPage(context.Context, *ManyVersions) (*empty.Empty, error) {
