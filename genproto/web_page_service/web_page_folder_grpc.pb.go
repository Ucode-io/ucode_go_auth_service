...
const (
	FolderService_CreateFolder_FullMethodName    = "/web_page_service.FolderService/CreateFolder"
	FolderService_GetListFolder_FullMethodName   = "/web_page_service.FolderService/GetListFolder"
	FolderService_GetSingleFolder_FullMethodName = "/web_page_service.FolderService/GetSingleFolder"
	FolderService_UpdateFolder_FullMethodName    = "/web_page_service.FolderService/UpdateFolder"
	FolderService_DeleteFolder_FullMethodName    = "/web_page_service.FolderService/DeleteFolder"
)
...
func (c *folderServiceClient) GetListFolder(ctx context.Context, in *GetListFolderReq, opts ...grpc.CallOption) (*GetListFolderRes, error) {
	...
	err := c.cc.Invoke(ctx, FolderService_GetListFolder_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
