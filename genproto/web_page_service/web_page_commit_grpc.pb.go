...
const (
	CommitService_Create_FullMethodName                = "/web_page_service.CommitService/Create"
	CommitService_GetByID_FullMethodName               = "/web_page_service.CommitService/GetByID"
	CommitService_Update_FullMethodName                = "/web_page_service.CommitService/Update"
	CommitService_GetList_FullMethodName               = "/web_page_service.CommitService/GetList"
	CommitService_Restore_FullMethodName               = "/web_page_service.CommitService/Restore"
	CommitService_Insert_FullMethodName                = "/web_page_service.CommitService/Insert"
	CommitService_GetMultipleCommitInfo_FullMethodName = "/web_page_service.CommitService/GetMultipleCommitInfo"
)
...
func (c *commitServiceClient) Create(ctx context.Context, in *CreateCommitRequest, opts ...grpc.CallOption) (*CommitWithRelease, error) {
	...
	err := c.cc.Invoke(ctx, CommitService_Create_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *commitServiceClient) GetByID(ctx context.Context, in *CommitPrimaryKey, opts ...grpc.CallOption) (*CommitWithRelease, error) {
	out := new(CommitWithRelease)
	err := c.cc.Invoke(ctx, CommitService_GetByID_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *commitServiceClient) Update(ctx context.Context, in *CommitWithRelease, opts ...grpc.CallOption) (*CommitWithRelease, error) {
	out := new(CommitWithRelease)
	err := c.cc.Invoke(ctx, CommitService_Update_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *commitServiceClient) GetList(ctx context.Context, in *GetCommitListRequest, opts ...grpc.CallOption) (*GetCommitListResponse, error) {
	...
	err := c.cc.Invoke(ctx, CommitService_GetList_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *commitServiceClient) Restore(ctx context.Context, in *RestoreCommitRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, CommitService_Restore_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *commitServiceClient) Insert(ctx context.Context, in *CreateCommitRequest, opts ...grpc.CallOption) (*InsertCommitResponse, error) {
	...
	err := c.cc.Invoke(ctx, CommitService_Insert_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *commitServiceClient) GetMultipleCommitInfo(ctx context.Context, in *GetMultipleCommitInfoRequest, opts ...grpc.CallOption) (*GetMultipleCommitInfoResponse, error) {
	...
	err := c.cc.Invoke(ctx, CommitService_GetMultipleCommitInfo_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var CommitService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "web_page_service.CommitService",
	...
	Metadata: "web_page_commit.proto",
}
