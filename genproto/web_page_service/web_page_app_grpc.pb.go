...
const (
	AppService_CreateApp_FullMethodName    = "/web_page_service.AppService/CreateApp"
	AppService_GetListApp_FullMethodName   = "/web_page_service.AppService/GetListApp"
	AppService_GetSingleApp_FullMethodName = "/web_page_service.AppService/GetSingleApp"
	AppService_UpdateApp_FullMethodName    = "/web_page_service.AppService/UpdateApp"
	AppService_DeleteApp_FullMethodName    = "/web_page_service.AppService/DeleteApp"
)
...
func (c *appServiceClient) GetListApp(ctx context.Context, in *GetListAppReq, opts ...grpc.CallOption) (*GetListAppRes, error) {
	...
	err := c.cc.Invoke(ctx, AppService_GetListApp_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *appServiceClient) GetSingleApp(ctx context.Context, in *GetSingleAppReq, opts ...grpc.CallOption) (*App, error) {
	out := new(App)
	err := c.cc.Invoke(ctx, AppService_GetSingleApp_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _AppService_GetListApp_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AppService_GetListApp_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _AppService_GetSingleApp_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AppService_GetSingleApp_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
