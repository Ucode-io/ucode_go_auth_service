...
type ClientServiceClient interface {
	...
	V2DeleteClientType(ctx context.Context, in *ClientTypePrimaryKey, opts ...grpc.CallOption) (*empty.Empty, error)
...
func (c *clientServiceClient) V2DeleteClientType(ctx context.Context, in *ClientTypePrimaryKey, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
type ClientServiceServer interface {
	...
	V2DeleteClientType(context.Context, *ClientTypePrimaryKey) (*empty.Empty, error)
...
func (UnimplementedClientServiceServer) V2DeleteClientType(context.Context, *ClientTypePrimaryKey) (*empty.Empty, error) {
