...
var file_session_service_proto_rawDesc = []byte{
	...
	0xba, 0x02, 0x0a, 0x0e, 0x56, 0x32, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x52, 0x65, 0x71, 0x75, 0x65,
	...
	0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x54, 0x79, 0x70, 0x65, 0x22, 0xc0, 0x01, 0x0a,
	...
	0x72, 0x61, 0x74, 0x65, 0x67, 0x79, 0x1a, 0x37, 0x0a, 0x09, 0x44, 0x61, 0x74, 0x61, 0x45, 0x6e,
	0x74, 0x72, 0x79, 0x12, 0x10, 0x0a, 0x03, 0x6b, 0x65, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x03, 0x6b, 0x65, 0x79, 0x12, 0x14, 0x0a, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x02,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22,
	0xe1, 0x01, 0x0a, 0x14, 0x56, 0x32, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x53, 0x75, 0x70, 0x65, 0x72,
	...
	0x69, 0x65, 0x73, 0x22, 0x4e, 0x0a, 0x14, 0x56, 0x32, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x53, 0x75,
	...
	0x6f, 0x72, 0x64, 0x22, 0xa3, 0x01, 0x0a, 0x16, 0x53, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x41,
	...
	0x70, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x49, 0x64, 0x22, 0x56, 0x0a, 0x1c, 0x55, 0x70, 0x64,
	...
	0x50, 0x0a, 0x16, 0x56, 0x32, 0x4d, 0x75, 0x6c, 0x74, 0x69, 0x43, 0x6f, 0x6d, 0x70, 0x61, 0x6e,
	...
	0x64, 0x22, 0xb3, 0x04, 0x0a, 0x16, 0x56, 0x32, 0x4d, 0x75, 0x6c, 0x74, 0x69, 0x43, 0x6f, 0x6d,
	...
	0x09, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x64, 0x41, 0x74, 0x32, 0xa9, 0x0c, 0x0a, 0x0e, 0x53,
...
var file_session_service_proto_depIdxs = []int32{
	...
	49, // 44: auth_service.V2LoginSuperAdminRes.token:type_name -> auth_service.Token
	51, // 45: auth_service.V2LoginSuperAdminRes.sessions:type_name -> auth_service.Session
	52, // 46: auth_service.V2LoginSuperAdminRes.companies:type_name -> auth_service.Company
	25, // 47: auth_service.SessionAndTokenRequest.login_data:type_name -> auth_service.V2LoginResponse
	23, // 48: auth_service.SessionAndTokenRequest.tables:type_name -> auth_service.Object
	45, // 49: auth_service.V2SuperAdminLoginResponse.client_platform:type_name -> auth_service.ClientPlatform
	46, // 50: auth_service.V2SuperAdminLoginResponse.client_type:type_name -> auth_service.ClientType
	48, // 51: auth_service.V2SuperAdminLoginResponse.role:type_name -> auth_service.Role
	49, // 52: auth_service.V2SuperAdminLoginResponse.token:type_name -> auth_service.Token
	24, // 53: auth_service.V2SuperAdminLoginResponse.permissions:type_name -> auth_service.RecordPermission
	51, // 54: auth_service.V2SuperAdminLoginResponse.sessions:type_name -> auth_service.Session
	24, // 55: auth_service.V2SuperAdminLoginResponse.app_permissions:type_name -> auth_service.RecordPermission
	52, // 56: auth_service.V2SuperAdminLoginResponse.companies:type_name -> auth_service.Company
	40, // 57: auth_service.V2MultiCompanyLoginRes.companies:type_name -> auth_service.V2MultiCompanyLoginRes.Company
	42, // 58: auth_service.MultiCompanyLoginResponse.companies:type_name -> auth_service.MultiCompanyLoginResponse.Company
	46, // 59: auth_service.MultiCompanyLoginResponse.client_types:type_name -> auth_service.ClientType
	41, // 60: auth_service.V2MultiCompanyLoginRes.Company.projects:type_name -> auth_service.V2MultiCompanyLoginRes.Company.Project
	43, // 61: auth_service.MultiCompanyLoginResponse.Company.projects:type_name -> auth_service.MultiCompanyLoginResponse.Company.Project
	6,  // 62: auth_service.SessionService.Login:input_type -> auth_service.LoginRequest
	8,  // 63: auth_service.SessionService.Logout:input_type -> auth_service.LogoutRequest
	9,  // 64: auth_service.SessionService.RefreshToken:input_type -> auth_service.RefreshTokenRequest
	13, // 65: auth_service.SessionService.HasAccess:input_type -> auth_service.HasAccessRequest
	15, // 66: auth_service.SessionService.HasAccessSuperAdmin:input_type -> auth_service.HasAccessSuperAdminReq
	27, // 67: auth_service.SessionService.V2Login:input_type -> auth_service.V2LoginRequest
	30, // 68: auth_service.SessionService.V2LoginSuperAdmin:input_type -> auth_service.V2LoginSuperAdminReq
	13, // 69: auth_service.SessionService.V2HasAccess:input_type -> auth_service.HasAccessRequest
	4,  // 70: auth_service.SessionService.V2HasAccessUser:input_type -> auth_service.V2HasAccessUserReq
	9,  // 71: auth_service.SessionService.V2RefreshToken:input_type -> auth_service.RefreshTokenRequest
	9,  // 72: auth_service.SessionService.V2RefreshTokenSuperAdmin:input_type -> auth_service.RefreshTokenRequest
	31, // 73: auth_service.SessionService.SessionAndTokenGenerator:input_type -> auth_service.SessionAndTokenRequest
	32, // 74: auth_service.SessionService.UpdateSessionsByRoleId:input_type -> auth_service.UpdateSessionByRoleIdRequest
	35, // 75: auth_service.SessionService.MultiCompanyLogin:input_type -> auth_service.MultiCompanyLoginRequest
	36, // 76: auth_service.SessionService.V2MultiCompanyLogin:input_type -> auth_service.V2MultiCompanyLoginReq
	36, // 77: auth_service.SessionService.V2MultiCompanyOneLogin:input_type -> auth_service.V2MultiCompanyLoginReq
	28, // 78: auth_service.SessionService.V2LoginWithOption:input_type -> auth_service.V2LoginWithOptionRequest
	7,  // 79: auth_service.SessionService.Login:output_type -> auth_service.LoginResponse
	53, // 80: auth_service.SessionService.Logout:output_type -> google.protobuf.Empty
	10, // 81: auth_service.SessionService.RefreshToken:output_type -> auth_service.RefreshTokenResponse
	14, // 82: auth_service.SessionService.HasAccess:output_type -> auth_service.HasAccessResponse
	16, // 83: auth_service.SessionService.HasAccessSuperAdmin:output_type -> auth_service.HasAccessSuperAdminRes
	25, // 84: auth_service.SessionService.V2Login:output_type -> auth_service.V2LoginResponse
	29, // 85: auth_service.SessionService.V2LoginSuperAdmin:output_type -> auth_service.V2LoginSuperAdminRes
	14, // 86: auth_service.SessionService.V2HasAccess:output_type -> auth_service.HasAccessResponse
	5,  // 87: auth_service.SessionService.V2HasAccessUser:output_type -> auth_service.V2HasAccessUserRes
	11, // 88: auth_service.SessionService.V2RefreshToken:output_type -> auth_service.V2RefreshTokenResponse
	12, // 89: auth_service.SessionService.V2RefreshTokenSuperAdmin:output_type -> auth_service.V2RefreshTokenSuperAdminResponse
	25, // 90: auth_service.SessionService.SessionAndTokenGenerator:output_type -> auth_service.V2LoginResponse
	53, // 91: auth_service.SessionService.UpdateSessionsByRoleId:output_type -> google.protobuf.Empty
	38, // 92: auth_service.SessionService.MultiCompanyLogin:output_type -> auth_service.MultiCompanyLoginResponse
	37, // 93: auth_service.SessionService.V2MultiCompanyLogin:output_type -> auth_service.V2MultiCompanyLoginRes
	3,  // 94: auth_service.SessionService.V2MultiCompanyOneLogin:output_type -> auth_service.V2MultiCompanyOneLoginRes
	26, // 95: auth_service.SessionService.V2LoginWithOption:output_type -> auth_service.V2LoginWithOptionsResponse
