...
var file_session_service_proto_rawDesc = []byte{
	...
	0x63, 0x6f, 0x6d, 0x70, 0x61, 0x6e, 0x69, 0x65, 0x73, 0x32, 0xfa, 0x05, 0x0a, 0x0e, 0x53, 0x65,
	...
	0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x48, 0x61, 0x73, 0x41, 0x63, 0x63, 0x65, 0x73, 0x73,
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x48, 0x0a, 0x07, 0x56, 0x32,
	...
	0x73, 0x65, 0x22, 0x00, 0x12, 0x50, 0x0a, 0x0b, 0x56, 0x32, 0x48, 0x61, 0x73, 0x41, 0x63, 0x63,
	...
	0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x5b, 0x0a, 0x0e, 0x56, 0x32, 0x52, 0x65, 0x66, 0x72,
	...
	0x65, 0x22, 0x00, 0x12, 0x61, 0x0a, 0x18, 0x53, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x41, 0x6e,
	0x64, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x47, 0x65, 0x6e, 0x65, 0x72, 0x61, 0x74, 0x6f, 0x72, 0x12,
	0x24, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x5f, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x53,
	...
	0x53, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x73, 0x42, 0x79, 0x52, 0x6f, 0x6c, 0x65, 0x49, 0x64,
	...
	0x6f, 0x6c, 0x65, 0x49, 0x64, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x16, 0x2e, 0x67,
...
var file_session_service_proto_msgTypes = make([]protoimpl.MessageInfo, 21)
var file_session_service_proto_goTypes = []interface{}{
	...
	(*ClientPlatform)(nil),               // 21: auth_service.ClientPlatform
	(*ClientType)(nil),                   // 22: auth_service.ClientType
	(*User)(nil),                         // 23: auth_service.User
	(*Role)(nil),                         // 24: auth_service.Role
	(*Token)(nil),                        // 25: auth_service.Token
	(*Permission)(nil),                   // 26: auth_service.Permission
	(*Session)(nil),                      // 27: auth_service.Session
	(*Company)(nil),                      // 28: auth_service.Company
	(*emptypb.Empty)(nil),                // 29: google.protobuf.Empty
}
var file_session_service_proto_depIdxs = []int32{
	14, // 0: auth_service.LoginRequest.tables:type_name -> auth_service.Object
	21, // 1: auth_service.LoginResponse.client_platform:type_name -> auth_service.ClientPlatform
	22, // 2: auth_service.LoginResponse.client_type:type_name -> auth_service.ClientType
	23, // 3: auth_service.LoginResponse.user:type_name -> auth_service.User
	24, // 4: auth_service.LoginResponse.role:type_name -> auth_service.Role
	25, // 5: auth_service.LoginResponse.token:type_name -> auth_service.Token
	26, // 6: auth_service.LoginResponse.permissions:type_name -> auth_service.Permission
	27, // 7: auth_service.LoginResponse.sessions:type_name -> auth_service.Session
	28, // 8: auth_service.LoginResponse.companies:type_name -> auth_service.Company
	25, // 9: auth_service.RefreshTokenResponse.token:type_name -> auth_service.Token
	25, // 10: auth_service.V2RefreshTokenResponse.token:type_name -> auth_service.Token
	...
	27, // 13: auth_service.GetSessionListResponse.sessions:type_name -> auth_service.Session
	21, // 14: auth_service.V2LoginResponse.client_platform:type_name -> auth_service.ClientPlatform
	22, // 15: auth_service.V2LoginResponse.client_type:type_name -> auth_service.ClientType
	24, // 16: auth_service.V2LoginResponse.role:type_name -> auth_service.Role
	25, // 17: auth_service.V2LoginResponse.token:type_name -> auth_service.Token
	15, // 18: auth_service.V2LoginResponse.permissions:type_name -> auth_service.RecordPermission
	27, // 19: auth_service.V2LoginResponse.sessions:type_name -> auth_service.Session
	...
	21, // 24: auth_service.V2SuperAdminLoginResponse.client_platform:type_name -> auth_service.ClientPlatform
	22, // 25: auth_service.V2SuperAdminLoginResponse.client_type:type_name -> auth_service.ClientType
	24, // 26: auth_service.V2SuperAdminLoginResponse.role:type_name -> auth_service.Role
	25, // 27: auth_service.V2SuperAdminLoginResponse.token:type_name -> auth_service.Token
	15, // 28: auth_service.V2SuperAdminLoginResponse.permissions:type_name -> auth_service.RecordPermission
	27, // 29: auth_service.V2SuperAdminLoginResponse.sessions:type_name -> auth_service.Session
	15, // 30: auth_service.V2SuperAdminLoginResponse.app_permissions:type_name -> auth_service.RecordPermission
	28, // 31: auth_service.V2SuperAdminLoginResponse.companies:type_name -> auth_service.Company
	0,  // 32: auth_service.SessionService.Login:input_type -> auth_service.LoginRequest
	2,  // 33: auth_service.SessionService.Logout:input_type -> auth_service.LogoutRequest
	3,  // 34: auth_service.SessionService.RefreshToken:input_type -> auth_service.RefreshTokenRequest
	6,  // 35: auth_service.SessionService.HasAccess:input_type -> auth_service.HasAccessRequest
	17, // 36: auth_service.SessionService.V2Login:input_type -> auth_service.V2LoginRequest
	6,  // 37: auth_service.SessionService.V2HasAccess:input_type -> auth_service.HasAccessRequest
	3,  // 38: auth_service.SessionService.V2RefreshToken:input_type -> auth_service.RefreshTokenRequest
	18, // 39: auth_service.SessionService.SessionAndTokenGenerator:input_type -> auth_service.SessionAndTokenRequest
	19, // 40: auth_service.SessionService.UpdateSessionsByRoleId:input_type -> auth_service.UpdateSessionByRoleIdRequest
	1,  // 41: auth_service.SessionService.Login:output_type -> auth_service.LoginResponse
	29, // 42: auth_service.SessionService.Logout:output_type -> google.protobuf.Empty
	4,  // 43: auth_service.SessionService.RefreshToken:output_type -> auth_service.RefreshTokenResponse
	7,  // 44: auth_service.SessionService.HasAccess:output_type -> auth_service.HasAccessResponse
	16, // 45: auth_service.SessionService.V2Login:output_type -> auth_service.V2LoginResponse
	7,  // 46: auth_service.SessionService.V2HasAccess:output_type -> auth_service.HasAccessResponse
	5,  // 47: auth_service.SessionService.V2RefreshToken:output_type -> auth_service.V2RefreshTokenResponse
	16, // 48: auth_service.SessionService.SessionAndTokenGenerator:output_type -> auth_service.V2LoginResponse
	29, // 49: auth_service.SessionService.UpdateSessionsByRoleId:output_type -> google.protobuf.Empty
