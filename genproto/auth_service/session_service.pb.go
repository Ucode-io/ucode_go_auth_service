...
func (*MultiCompanyLoginResponse_Company) Descriptor() ([]byte, []int) {
	return file_session_service_proto_rawDescGZIP(), []int{22, 0}
}
...
func (*MultiCompanyLoginResponse_Company_Project) Descriptor() ([]byte, []int) {
	return file_session_service_proto_rawDescGZIP(), []int{22, 0, 0}
}
...
var file_session_service_proto_rawDesc = []byte{
	...
	0x73, 0x22, 0xae, 0x01, 0x0a, 0x10, 0x48, 0x61, 0x73, 0x41, 0x63, 0x63, 0x65, 0x73, 0x73, 0x52,
	...
	0x6f, 0x64, 0x22, 0xfa, 0x02, 0x0a, 0x11, 0x48, 0x61, 0x73, 0x41, 0x63, 0x63, 0x65, 0x73, 0x73,
	...
	0x74, 0x49, 0x64, 0x22, 0xa3, 0x01, 0x0a, 0x16, 0x53, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x41,
	...
	0x01, 0x28, 0x09, 0x52, 0x08, 0x70, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x22, 0xe0, 0x04,
	...
	0x32, 0xe2, 0x06, 0x0a, 0x0e, 0x53, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x53, 0x65, 0x72, 0x76,
	...
	0x00, 0x12, 0x48, 0x0a, 0x07, 0x56, 0x32, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x12, 0x1c, 0x2e, 0x61,
	...
	0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x50, 0x0a, 0x0b, 0x56,
...
var file_session_service_proto_msgTypes = make([]protoimpl.MessageInfo, 25)
var file_session_service_proto_goTypes = []interface{}{
	...
	(*HasAccessRequest)(nil),                          // 6: auth_service.HasAccessRequest
	(*HasAccessResponse)(nil),                         // 7: auth_service.HasAccessResponse
	(*TableBody)(nil),                                 // 8: auth_service.TableBody
	(*CreateSessionRequest)(nil),                      // 9: auth_service.CreateSessionRequest
	(*UpdateSessionRequest)(nil),                      // 10: auth_service.UpdateSessionRequest
	(*SessionPrimaryKey)(nil),                         // 11: auth_service.SessionPrimaryKey
	(*GetSessionListRequest)(nil),                     // 12: auth_service.GetSessionListRequest
	(*GetSessionListResponse)(nil),                    // 13: auth_service.GetSessionListResponse
	(*Object)(nil),                                    // 14: auth_service.Object
	(*RecordPermission)(nil),                          // 15: auth_service.RecordPermission
	(*V2LoginResponse)(nil),                           // 16: auth_service.V2LoginResponse
	(*V2LoginRequest)(nil),                            // 17: auth_service.V2LoginRequest
	(*SessionAndTokenRequest)(nil),                    // 18: auth_service.SessionAndTokenRequest
	(*UpdateSessionByRoleIdRequest)(nil),              // 19: auth_service.UpdateSessionByRoleIdRequest
	(*V2SuperAdminLoginResponse)(nil),                 // 20: auth_service.V2SuperAdminLoginResponse
	(*MultiCompanyLoginRequest)(nil),                  // 21: auth_service.MultiCompanyLoginRequest
	(*MultiCompanyLoginResponse)(nil),                 // 22: auth_service.MultiCompanyLoginResponse
	(*MultiCompanyLoginResponse_Company)(nil),         // 23: auth_service.MultiCompanyLoginResponse.Company
	(*MultiCompanyLoginResponse_Company_Project)(nil), // 24: auth_service.MultiCompanyLoginResponse.Company.Project
	(*ClientPlatform)(nil),                            // 25: auth_service.ClientPlatform
	(*ClientType)(nil),                                // 26: auth_service.ClientType
	(*User)(nil),                                      // 27: auth_service.User
	(*Role)(nil),                                      // 28: auth_service.Role
	(*Token)(nil),                                     // 29: auth_service.Token
	(*Permission)(nil),                                // 30: auth_service.Permission
	(*Session)(nil),                                   // 31: auth_service.Session
	(*Company)(nil),                                   // 32: auth_service.Company
	(*emptypb.Empty)(nil),                             // 33: google.protobuf.Empty
}
var file_session_service_proto_depIdxs = []int32{
	14, // 0: auth_service.LoginRequest.tables:type_name -> auth_service.Object
	25, // 1: auth_service.LoginResponse.client_platform:type_name -> auth_service.ClientPlatform
	26, // 2: auth_service.LoginResponse.client_type:type_name -> auth_service.ClientType
	27, // 3: auth_service.LoginResponse.user:type_name -> auth_service.User
	28, // 4: auth_service.LoginResponse.role:type_name -> auth_service.Role
	29, // 5: auth_service.LoginResponse.token:type_name -> auth_service.Token
	30, // 6: auth_service.LoginResponse.permissions:type_name -> auth_service.Permission
	31, // 7: auth_service.LoginResponse.sessions:type_name -> auth_service.Session
	32, // 8: auth_service.LoginResponse.companies:type_name -> auth_service.Company
	29, // 9: auth_service.RefreshTokenResponse.token:type_name -> auth_service.Token
	29, // 10: auth_service.V2RefreshTokenResponse.token:type_name -> auth_service.Token
	15, // 11: auth_service.V2RefreshTokenResponse.permissions:type_name -> auth_service.RecordPermission
	8,  // 12: auth_service.HasAccessResponse.tables:type_name -> auth_service.TableBody
	31, // 13: auth_service.GetSessionListResponse.sessions:type_name -> auth_service.Session
	25, // 14: auth_service.V2LoginResponse.client_platform:type_name -> auth_service.ClientPlatform
	26, // 15: auth_service.V2LoginResponse.client_type:type_name -> auth_service.ClientType
	28, // 16: auth_service.V2LoginResponse.role:type_name -> auth_service.Role
	29, // 17: auth_service.V2LoginResponse.token:type_name -> auth_service.Token
	15, // 18: auth_service.V2LoginResponse.permissions:type_name -> auth_service.RecordPermission
	31, // 19: auth_service.V2LoginResponse.sessions:type_name -> auth_service.Session
	15, // 20: auth_service.V2LoginResponse.app_permissions:type_name -> auth_service.RecordPermission
	14, // 21: auth_service.V2LoginRequest.tables:type_name -> auth_service.Object
	16, // 22: auth_service.SessionAndTokenRequest.login_data:type_name -> auth_service.V2LoginResponse
	14, // 23: auth_service.SessionAndTokenRequest.tables:type_name -> auth_service.Object
	25, // 24: auth_service.V2SuperAdminLoginResponse.client_platform:type_name -> auth_service.ClientPlatform
	26, // 25: auth_service.V2SuperAdminLoginResponse.client_type:type_name -> auth_service.ClientType
	28, // 26: auth_service.V2SuperAdminLoginResponse.role:type_name -> auth_service.Role
	29, // 27: auth_service.V2SuperAdminLoginResponse.token:type_name -> auth_service.Token
	15, // 28: auth_service.V2SuperAdminLoginResponse.permissions:type_name -> auth_service.RecordPermission
	31, // 29: auth_service.V2SuperAdminLoginResponse.sessions:type_name -> auth_service.Session
	15, // 30: auth_service.V2SuperAdminLoginResponse.app_permissions:type_name -> auth_service.RecordPermission
	32, // 31: auth_service.V2SuperAdminLoginResponse.companies:type_name -> auth_service.Company
	23, // 32: auth_service.MultiCompanyLoginResponse.companies:type_name -> auth_service.MultiCompanyLoginResponse.Company
	26, // 33: auth_service.MultiCompanyLoginResponse.client_types:type_name -> auth_service.ClientType
	24, // 34: auth_service.MultiCompanyLoginResponse.Company.projects:type_name -> auth_service.MultiCompanyLoginResponse.Company.Project
	0,  // 35: auth_service.SessionService.Login:input_type -> auth_service.LoginRequest
	2,  // 36: auth_service.SessionService.Logout:input_type -> auth_service.LogoutRequest
	3,  // 37: auth_service.SessionService.RefreshToken:input_type -> auth_service.RefreshTokenRequest
	6,  // 38: auth_service.SessionService.HasAccess:input_type -> auth_service.HasAccessRequest
	17, // 39: auth_service.SessionService.V2Login:input_type -> auth_service.V2LoginRequest
	6,  // 40: auth_service.SessionService.V2HasAccess:input_type -> auth_service.HasAccessRequest
	3,  // 41: auth_service.SessionService.V2RefreshToken:input_type -> auth_service.RefreshTokenRequest
	18, // 42: auth_service.SessionService.SessionAndTokenGenerator:input_type -> auth_service.SessionAndTokenRequest
	19, // 43: auth_service.SessionService.UpdateSessionsByRoleId:input_type -> auth_service.UpdateSessionByRoleIdRequest
	21, // 44: auth_service.SessionService.MultiCompanyLogin:input_type -> auth_service.MultiCompanyLoginRequest
	1,  // 45: auth_service.SessionService.Login:output_type -> auth_service.LoginResponse
	33, // 46: auth_service.SessionService.Logout:output_type -> google.protobuf.Empty
	4,  // 47: auth_service.SessionService.RefreshToken:output_type -> auth_service.RefreshTokenResponse
	7,  // 48: auth_service.SessionService.HasAccess:output_type -> auth_service.HasAccessResponse
	16, // 49: auth_service.SessionService.V2Login:output_type -> auth_service.V2LoginResponse
	7,  // 50: auth_service.SessionService.V2HasAccess:output_type -> auth_service.HasAccessResponse
	5,  // 51: auth_service.SessionService.V2RefreshToken:output_type -> auth_service.V2RefreshTokenResponse
	16, // 52: auth_service.SessionService.SessionAndTokenGenerator:output_type -> auth_service.V2LoginResponse
	33, // 53: auth_service.SessionService.UpdateSessionsByRoleId:output_type -> google.protobuf.Empty
	22, // 54: auth_service.SessionService.MultiCompanyLogin:output_type -> auth_service.MultiCompanyLoginResponse
