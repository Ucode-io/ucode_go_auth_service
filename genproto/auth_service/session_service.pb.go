...
var file_session_service_proto_rawDesc = []byte{
	...
	0x18, 0x08, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x64, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x22, 0xf6,
	...
	0x72, 0x52, 0x04, 0x75, 0x73, 0x65, 0x72, 0x22, 0x95, 0x02, 0x0a, 0x0e, 0x56, 0x32, 0x4c, 0x6f,
...
var file_session_service_proto_depIdxs = []int32{
	...
	19, // 25: auth_service.V2LoginRequest.tables:type_name -> auth_service.Object
	41, // 26: auth_service.V2LoginSuperAdminRes.token:type_name -> auth_service.Token
	43, // 27: auth_service.V2LoginSuperAdminRes.sessions:type_name -> auth_service.Session
	44, // 28: auth_service.V2LoginSuperAdminRes.companies:type_name -> auth_service.Company
	21, // 29: auth_service.SessionAndTokenRequest.login_data:type_name -> auth_service.V2LoginResponse
	19, // 30: auth_service.SessionAndTokenRequest.tables:type_name -> auth_service.Object
	37, // 31: auth_service.V2SuperAdminLoginResponse.client_platform:type_name -> auth_service.ClientPlatform
	38, // 32: auth_service.V2SuperAdminLoginResponse.client_type:type_name -> auth_service.ClientType
	40, // 33: auth_service.V2SuperAdminLoginResponse.role:type_name -> auth_service.Role
	41, // 34: auth_service.V2SuperAdminLoginResponse.token:type_name -> auth_service.Token
	20, // 35: auth_service.V2SuperAdminLoginResponse.permissions:type_name -> auth_service.RecordPermission
	43, // 36: auth_service.V2SuperAdminLoginResponse.sessions:type_name -> auth_service.Session
	20, // 37: auth_service.V2SuperAdminLoginResponse.app_permissions:type_name -> auth_service.RecordPermission
	44, // 38: auth_service.V2SuperAdminLoginResponse.companies:type_name -> auth_service.Company
	33, // 39: auth_service.V2MultiCompanyLoginRes.companies:type_name -> auth_service.V2MultiCompanyLoginRes.Company
	35, // 40: auth_service.MultiCompanyLoginResponse.companies:type_name -> auth_service.MultiCompanyLoginResponse.Company
	38, // 41: auth_service.MultiCompanyLoginResponse.client_types:type_name -> auth_service.ClientType
	34, // 42: auth_service.V2MultiCompanyLoginRes.Company.projects:type_name -> auth_service.V2MultiCompanyLoginRes.Company.Project
	36, // 43: auth_service.MultiCompanyLoginResponse.Company.projects:type_name -> auth_service.MultiCompanyLoginResponse.Company.Project
	2,  // 44: auth_service.SessionService.Login:input_type -> auth_service.LoginRequest
	4,  // 45: auth_service.SessionService.Logout:input_type -> auth_service.LogoutRequest
	5,  // 46: auth_service.SessionService.RefreshToken:input_type -> auth_service.RefreshTokenRequest
	9,  // 47: auth_service.SessionService.HasAccess:input_type -> auth_service.HasAccessRequest
	11, // 48: auth_service.SessionService.HasAccessSuperAdmin:input_type -> auth_service.HasAccessSuperAdminReq
	22, // 49: auth_service.SessionService.V2Login:input_type -> auth_service.V2LoginRequest
	24, // 50: auth_service.SessionService.V2LoginSuperAdmin:input_type -> auth_service.V2LoginSuperAdminReq
	9,  // 51: auth_service.SessionService.V2HasAccess:input_type -> auth_service.HasAccessRequest
	0,  // 52: auth_service.SessionService.V2HasAccessUser:input_type -> auth_service.V2HasAccessUserReq
	5,  // 53: auth_service.SessionService.V2RefreshToken:input_type -> auth_service.RefreshTokenRequest
	5,  // 54: auth_service.SessionService.V2RefreshTokenSuperAdmin:input_type -> auth_service.RefreshTokenRequest
	25, // 55: auth_service.SessionService.SessionAndTokenGenerator:input_type -> auth_service.SessionAndTokenRequest
	26, // 56: auth_service.SessionService.UpdateSessionsByRoleId:input_type -> auth_service.UpdateSessionByRoleIdRequest
	29, // 57: auth_service.SessionService.MultiCompanyLogin:input_type -> auth_service.MultiCompanyLoginRequest
	30, // 58: auth_service.SessionService.V2MultiCompanyLogin:input_type -> auth_service.V2MultiCompanyLoginReq
	3,  // 59: auth_service.SessionService.Login:output_type -> auth_service.LoginResponse
	45, // 60: auth_service.SessionService.Logout:output_type -> google.protobuf.Empty
	6,  // 61: auth_service.SessionService.RefreshToken:output_type -> auth_service.RefreshTokenResponse
	10, // 62: auth_service.SessionService.HasAccess:output_type -> auth_service.HasAccessResponse
	12, // 63: auth_service.SessionService.HasAccessSuperAdmin:output_type -> auth_service.HasAccessSuperAdminRes
	21, // 64: auth_service.SessionService.V2Login:output_type -> auth_service.V2LoginResponse
	23, // 65: auth_service.SessionService.V2LoginSuperAdmin:output_type -> auth_service.V2LoginSuperAdminRes
	10, // 66: auth_service.SessionService.V2HasAccess:output_type -> auth_service.HasAccessResponse
	1,  // 67: auth_service.SessionService.V2HasAccessUser:output_type -> auth_service.V2HasAccessUserRes
	7,  // 68: auth_service.SessionService.V2RefreshToken:output_type -> auth_service.V2RefreshTokenResponse
	8,  // 69: auth_service.SessionService.V2RefreshTokenSuperAdmin:output_type -> auth_service.V2RefreshTokenSuperAdminResponse
	21, // 70: auth_service.SessionService.SessionAndTokenGenerator:output_type -> auth_service.V2LoginResponse
	45, // 71: auth_service.SessionService.UpdateSessionsByRoleId:output_type -> google.protobuf.Empty
	32, // 72: auth_service.SessionService.MultiCompanyLogin:output_type -> auth_service.MultiCompanyLoginResponse
	31, // 73: auth_service.SessionService.V2MultiCompanyLogin:output_type -> auth_service.V2MultiCompanyLoginRes
