...
type CreateDistrict struct {
	...
	DistrictId   string `protobuf:"bytes,1,opt,name=districtId,proto3" json:"districtId"`
	Name         string `protobuf:"bytes,2,opt,name=name,proto3" json:"name"`
	Lang         string `protobuf:"bytes,3,opt,name=lang,proto3" json:"lang"`
	DistrictCode int32  `protobuf:"varint,4,opt,name=districtCode,proto3" json:"districtCode"`
	RegionId     string `protobuf:"bytes,5,opt,name=regionId,proto3" json:"regionId"`
}
...
type District struct {
	...
	Lang         string `protobuf:"bytes,3,opt,name=lang,proto3" json:"lang"`
	DistrictCode int32  `protobuf:"varint,4,opt,name=districtCode,proto3" json:"districtCode"`
	RegionId     int64  `protobuf:"varint,5,opt,name=regionId,proto3" json:"regionId"`
}
...
type GetListDistrictsResponse struct {
	...
	Districts []*District `protobuf:"bytes,1,rep,name=districts,proto3" json:"districts"`
