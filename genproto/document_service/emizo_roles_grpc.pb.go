...
func (c *eimzoRolesClient) Create(ctx context.Context, in *CreateRoleReq, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, EimzoRoles_Create_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *eimzoRolesClient) Get(ctx context.Context, in *RoleGetReq, opts ...grpc.CallOption) (*RoleGetRes, error) {
	out := new(RoleGetRes)
	err := c.cc.Invoke(ctx, EimzoRoles_Get_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *eimzoRolesClient) Reload(ctx context.Context, in *ReloadReq, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, EimzoRoles_Reload_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
