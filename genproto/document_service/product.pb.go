...
type ProductDetails struct {
	...
	Pinfl    string `protobuf:"bytes,2,opt,name=pinfl,proto3" json:"pinfl"`
	Id       string `protobuf:"bytes,3,opt,name=id,proto3" json:"id"`
	Lang     string `protobuf:"bytes,4,opt,name=lang,proto3" json:"lang"`
	MxikCode string `protobuf:"bytes,5,opt,name=mxikCode,proto3" json:"mxikCode"`
}
...
type GetAllProductRequest struct {
	...
	Tin    string `protobuf:"bytes,4,opt,name=tin,proto3" json:"tin"`
...
type GetAllProductResponse struct {
	...
	Products []*ProductsList `protobuf:"bytes,2,rep,name=products,proto3" json:"products"`
}
...
type GetAllProducts struct {
	...
	Data []*ProductRequest `protobuf:"bytes,1,rep,name=data,proto3" json:"data"`
}
...
type ProductsList struct {
	...
	CommonUnitCode    int64                   `protobuf:"varint,3,opt,name=commonUnitCode,proto3" json:"commonUnitCode"`
	CommonUnitName    string                  `protobuf:"bytes,4,opt,name=commonUnitName,proto3" json:"commonUnitName"`
	GroupName         string                  `protobuf:"bytes,5,opt,name=groupName,proto3" json:"groupName"`
	IsActive          int64                   `protobuf:"varint,6,opt,name=isActive,proto3" json:"isActive"`
	Label             int64                   `protobuf:"varint,7,opt,name=label,proto3" json:"label"`
	MxikCode          string                  `protobuf:"bytes,8,opt,name=mxikCode,proto3" json:"mxikCode"`
	Pkey              string                  `protobuf:"bytes,9,opt,name=pkey,proto3" json:"pkey"`
	PositionName      string                  `protobuf:"bytes,10,opt,name=positionName,proto3" json:"positionName"`
	SubPositionName   string                  `protobuf:"bytes,11,opt,name=subPositionName,proto3" json:"subPositionName"`
	PackageNames      []*PackageNames         `protobuf:"bytes,12,rep,name=packageNames,proto3" json:"packageNames"`
	Tin               string                  `protobuf:"bytes,13,opt,name=tin,proto3" json:"tin"`
	UnitCode          int64                   `protobuf:"varint,14,opt,name=unitCode,proto3" json:"unitCode"`
	UnitName          string                  `protobuf:"bytes,15,opt,name=unitName,proto3" json:"unitName"`
	UnitValue         string                  `protobuf:"bytes,16,opt,name=unitValue,proto3" json:"unitValue"`
	UsePackage        string                  `protobuf:"bytes,17,opt,name=usePackage,proto3" json:"usePackage"`
	Units             []*Units                `protobuf:"bytes,18,rep,name=units,proto3" json:"units"`
	Pinfl             string                  `protobuf:"bytes,19,opt,name=pinfl,proto3" json:"pinfl"`
	InternationalCode *wrapperspb.StringValue `protobuf:"bytes,20,opt,name=internationalCode,proto3" json:"internationalCode"`
	BrandName         *wrapperspb.StringValue `protobuf:"bytes,21,opt,name=brandName,proto3" json:"brandName"`
	AttributeName     *wrapperspb.StringValue `protobuf:"bytes,22,opt,name=attributeName,proto3" json:"attributeName"`
}
...
type ReloadProductReq struct {
	...
	Data []*ReloadData `protobuf:"bytes,2,rep,name=data,proto3" json:"data"`
}
...
type ReloadData struct {
	...
	BrandName         *wrapperspb.StringValue `protobuf:"bytes,21,opt,name=brandName,proto3" json:"brandName"`
	AttributeName     *wrapperspb.StringValue `protobuf:"bytes,22,opt,name=attributeName,proto3" json:"attributeName"`
	MxikFullname      string                  `protobuf:"bytes,23,opt,name=mxikFullname,proto3" json:"mxikFullname"`
	UsePackage2       string                  `protobuf:"bytes,24,opt,name=usePackage2,proto3" json:"usePackage2"`
	Lang              string                  `protobuf:"bytes,25,opt,name=lang,proto3" json:"lang"`
}
...
type ProductRequest struct {
	...
	CommonUnitCode    int64                   `protobuf:"varint,2,opt,name=commonUnitCode,proto3" json:"commonUnitCode"`
	CommonUnitName    string                  `protobuf:"bytes,3,opt,name=commonUnitName,proto3" json:"commonUnitName"`
	GroupName         string                  `protobuf:"bytes,4,opt,name=groupName,proto3" json:"groupName"`
	IsActive          int64                   `protobuf:"varint,5,opt,name=isActive,proto3" json:"isActive"`
	Label             int64                   `protobuf:"varint,6,opt,name=label,proto3" json:"label"`
	MxikCode          string                  `protobuf:"bytes,7,opt,name=mxikCode,proto3" json:"mxikCode"`
	Pkey              string                  `protobuf:"bytes,8,opt,name=pkey,proto3" json:"pkey"`
	PositionName      string                  `protobuf:"bytes,9,opt,name=positionName,proto3" json:"positionName"`
	SubPositionName   string                  `protobuf:"bytes,10,opt,name=subPositionName,proto3" json:"subPositionName"`
	PackageNames      []*CreatePackageNames   `protobuf:"bytes,11,rep,name=packageNames,proto3" json:"packageNames"`
	Tin               string                  `protobuf:"bytes,12,opt,name=tin,proto3" json:"tin"`
	UnitCode          int64                   `protobuf:"varint,13,opt,name=unitCode,proto3" json:"unitCode"`
	UnitName          string                  `protobuf:"bytes,14,opt,name=unitName,proto3" json:"unitName"`
	UnitValue         string                  `protobuf:"bytes,15,opt,name=unitValue,proto3" json:"unitValue"`
	UsePackage        string                  `protobuf:"bytes,16,opt,name=usePackage,proto3" json:"usePackage"`
	Units             []*CreateUnit           `protobuf:"bytes,17,rep,name=units,proto3" json:"units"`
	Pinfl             string                  `protobuf:"bytes,18,opt,name=pinfl,proto3" json:"pinfl"`
	Lang              string                  `protobuf:"bytes,19,opt,name=lang,proto3" json:"lang"`
	InternationalCode *wrapperspb.StringValue `protobuf:"bytes,20,opt,name=internationalCode,proto3" json:"internationalCode"`
	BrandName         *wrapperspb.StringValue `protobuf:"bytes,21,opt,name=brand_name,json=brandName,proto3" json:"brand_name"`
	AttributeName     *wrapperspb.StringValue `protobuf:"bytes,22,opt,name=attribute_name,json=attributeName,proto3" json:"attribute_name"`
}
...
type Units struct {
	...
	CommonUnitsId int64  `protobuf:"varint,1,opt,name=commonUnitsId,proto3" json:"commonUnitsId"`
	Description   string `protobuf:"bytes,2,opt,name=description,proto3" json:"description"`
	Difference    string `protobuf:"bytes,3,opt,name=difference,proto3" json:"difference"`
	Id            string `protobuf:"bytes,4,opt,name=id,proto3" json:"id"`
	Name          string `protobuf:"bytes,5,opt,name=name,proto3" json:"name"`
	NameLatin     string `protobuf:"bytes,6,opt,name=nameLatin,proto3" json:"nameLatin"`
	NameRu        string `protobuf:"bytes,7,opt,name=nameRu,proto3" json:"nameRu"`
	NameUz        string `protobuf:"bytes,8,opt,name=nameUz,proto3" json:"nameUz"`
	Unit          string `protobuf:"bytes,9,opt,name=unit,proto3" json:"unit"`
	ProductId     string `protobuf:"bytes,10,opt,name=productId,proto3" json:"productId"`
}
...
type CreateUnit struct {
	...
	NameLatin     string `protobuf:"bytes,5,opt,name=nameLatin,proto3" json:"nameLatin"`
	NameRu        string `protobuf:"bytes,6,opt,name=nameRu,proto3" json:"nameRu"`
	NameUz        string `protobuf:"bytes,7,opt,name=nameUz,proto3" json:"nameUz"`
...
type PackageNames struct {
	...
	MxikCode    string `protobuf:"bytes,2,opt,name=mxikCode,proto3" json:"mxikCode"`
	NameLat     string `protobuf:"bytes,3,opt,name=nameLat,proto3" json:"nameLat"`
	NameRu      string `protobuf:"bytes,4,opt,name=nameRu,proto3" json:"nameRu"`
	NameUz      string `protobuf:"bytes,5,opt,name=nameUz,proto3" json:"nameUz"`
	PackageType string `protobuf:"bytes,6,opt,name=packageType,proto3" json:"packageType"`
	Id          string `protobuf:"bytes,7,opt,name=id,proto3" json:"id"`
	ProductId   string `protobuf:"bytes,8,opt,name=product_id,json=productId,proto3" json:"product_id"`
}
