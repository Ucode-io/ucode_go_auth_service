...
const (
	ProjectService_Register_FullMethodName       = "/api_reference_service.ProjectService/Register"
	ProjectService_Deregister_FullMethodName     = "/api_reference_service.ProjectService/Deregister"
	ProjectService_Reconnect_FullMethodName      = "/api_reference_service.ProjectService/Reconnect"
	ProjectService_RegisterMany_FullMethodName   = "/api_reference_service.ProjectService/RegisterMany"
	ProjectService_DeregisterMany_FullMethodName = "/api_reference_service.ProjectService/DeregisterMany"
)
...
func (c *projectServiceClient) Register(ctx context.Context, in *RegisterProjectRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, ProjectService_Register_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *projectServiceClient) Deregister(ctx context.Context, in *DeregisterProjectRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, ProjectService_Deregister_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *projectServiceClient) Reconnect(ctx context.Context, in *RegisterProjectRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, ProjectService_Reconnect_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *projectServiceClient) RegisterMany(ctx context.Context, in *RegisterManyProjectsRequest, opts ...grpc.CallOption) (*RegisterManyProjectsResponse, error) {
	...
	err := c.cc.Invoke(ctx, ProjectService_RegisterMany_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *projectServiceClient) DeregisterMany(ctx context.Context, in *DeregisterManyProjectsRequest, opts ...grpc.CallOption) (*DeregisterManyProjectsResponse, error) {
	...
	err := c.cc.Invoke(ctx, ProjectService_DeregisterMany_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var ProjectService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api_reference_service.ProjectService",
	...
	Metadata: "api_reference_project.proto",
}
