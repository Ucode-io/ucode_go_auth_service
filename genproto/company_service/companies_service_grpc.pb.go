...
func (c *companyServiceClient) GetList(ctx context.Context, in *GetCompanyListRequest, opts ...grpc.CallOption) (*GetComanyListResponse, error) {
	...
	err := c.cc.Invoke(ctx, CompanyService_GetList_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *companyServiceClient) GetById(ctx context.Context, in *GetCompanyByIdRequest, opts ...grpc.CallOption) (*GetCompanyByIdResponse, error) {
	...
	err := c.cc.Invoke(ctx, CompanyService_GetById_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *companyServiceClient) Update(ctx context.Context, in *Company, opts ...grpc.CallOption) (*Company, error) {
	out := new(Company)
	err := c.cc.Invoke(ctx, CompanyService_Update_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *companyServiceClient) GetListWithProjects(ctx context.Context, in *GetListWithProjectsRequest, opts ...grpc.CallOption) (*GetListWithProjectsResponse, error) {
	...
	err := c.cc.Invoke(ctx, CompanyService_GetListWithProjects_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *companyServiceClient) GetCompaniesByOwnerId(ctx context.Context, in *GetCompaniesByOwnerIdReq, opts ...grpc.CallOption) (*GetCompaniesByOwnerIdRes, error) {
	...
	err := c.cc.Invoke(ctx, CompanyService_GetCompaniesByOwnerId_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *companyServiceClient) GetAllMenuTemplate(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*GatAllMenuTemplateResponse, error) {
	...
	err := c.cc.Invoke(ctx, CompanyService_GetAllMenuTemplate_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *companyServiceClient) GetMenuTemplateById(ctx context.Context, in *GetMenuTemplateRequest, opts ...grpc.CallOption) (*MenuTemplate, error) {
	...
	err := c.cc.Invoke(ctx, CompanyService_GetMenuTemplateById_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
