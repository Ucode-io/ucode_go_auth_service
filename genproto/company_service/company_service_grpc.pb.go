...
type CompanyServiceClient interface {
	...
	UpdateCompany(ctx context.Context, in *Comany, opts ...grpc.CallOption) (*Comany, error)
...
func (c *companyServiceClient) UpdateCompany(ctx context.Context, in *Comany, opts ...grpc.CallOption) (*Comany, error) {
	out := new(Comany)
...
type CompanyServiceServer interface {
	...
	UpdateCompany(context.Context, *Comany) (*Comany, error)
...
func (UnimplementedCompanyServiceServer) UpdateCompany(context.Context, *Comany) (*Comany, error) {
...
func _CompanyService_UpdateCompany_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CompanyServiceServer).UpdateCompany(ctx, req.(*Comany))
	}
	return interceptor(ctx, in, info, handler)
}
