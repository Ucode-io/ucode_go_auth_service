...
type GetListSettingReq struct {
	...
	Type      SettingType `protobuf:"varint,1,opt,name=type,proto3,enum=company_service.SettingType" json:"type"`
...
type Project struct {
	...
	Language     *Language                  `protobuf:"bytes,7,opt,name=language,proto3" json:"language"`
	Currency     *Currency                  `protobuf:"bytes,8,opt,name=currency,proto3" json:"currency"`
	Timezone     *Timezone                  `protobuf:"bytes,9,opt,name=timezone,proto3" json:"timezone"`
}
...
type AddResourceRequest struct {
	...
	IsDefault     bool                  `protobuf:"varint,10,opt,name=is_default,json=isDefault,proto3" json:"is_default"`
}
...
type ReconnectResourceRes struct {
	...
	ReconnectStatus []*ReconnectResourceRes_ReconnectStatus `protobuf:"bytes,1,rep,name=reconnect_status,json=reconnectStatus,proto3" json:"reconnect_status"`
}
