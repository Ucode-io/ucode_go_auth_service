...
const (
	EventService_Create_FullMethodName    = "/object_builder_service.EventService/Create"
	EventService_GetList_FullMethodName   = "/object_builder_service.EventService/GetList"
	EventService_GetSingle_FullMethodName = "/object_builder_service.EventService/GetSingle"
	EventService_Update_FullMethodName    = "/object_builder_service.EventService/Update"
	EventService_Delete_FullMethodName    = "/object_builder_service.EventService/Delete"
)
...
func (c *eventServiceClient) GetSingle(ctx context.Context, in *EventPrimaryKey, opts ...grpc.CallOption) (*Event, error) {
	out := new(Event)
	err := c.cc.Invoke(ctx, EventService_GetSingle_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _EventService_GetSingle_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: EventService_GetSingle_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
