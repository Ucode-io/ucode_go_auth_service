...
type EventServiceClient interface {
	...
	Update(ctx context.Context, in *Event, opts ...grpc.CallOption) (*empty.Empty, error)
...
func (c *eventServiceClient) Update(ctx context.Context, in *Event, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
type EventServiceServer interface {
	...
	Update(context.Context, *Event) (*empty.Empty, error)
...
func (UnimplementedEventServiceServer) Update(context.Context, *Event) (*empty.Empty, error) {
