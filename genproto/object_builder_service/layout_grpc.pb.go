...
const (
	LayoutService_CreateAll_FullMethodName       = "/object_builder_service.LayoutService/CreateAll"
	LayoutService_Update_FullMethodName          = "/object_builder_service.LayoutService/Update"
	LayoutService_GetAll_FullMethodName          = "/object_builder_service.LayoutService/GetAll"
	LayoutService_GetSingleLayout_FullMethodName = "/object_builder_service.LayoutService/GetSingleLayout"
	LayoutService_RemoveLayout_FullMethodName    = "/object_builder_service.LayoutService/RemoveLayout"
)
...
func (c *layoutServiceClient) CreateAll(ctx context.Context, in *CreateLayoutRequest, opts ...grpc.CallOption) (*GetListLayoutResponse, error) {
	...
	err := c.cc.Invoke(ctx, LayoutService_CreateAll_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *layoutServiceClient) Update(ctx context.Context, in *LayoutRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, LayoutService_Update_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *layoutServiceClient) GetAll(ctx context.Context, in *GetListLayoutRequest, opts ...grpc.CallOption) (*GetListLayoutResponse, error) {
	out := new(GetListLayoutResponse)
	err := c.cc.Invoke(ctx, LayoutService_GetAll_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *layoutServiceClient) GetSingleLayout(ctx context.Context, in *GetSingleLayoutRequest, opts ...grpc.CallOption) (*LayoutResponse, error) {
	...
	err := c.cc.Invoke(ctx, LayoutService_GetSingleLayout_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *layoutServiceClient) RemoveLayout(ctx context.Context, in *LayoutPrimaryKey, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, LayoutService_RemoveLayout_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
