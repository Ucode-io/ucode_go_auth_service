...
const (
	...
	ObjectBuilderService_GetObjectDetails_FullMethodName      = "/object_builder_service.ObjectBuilderService/GetObjectDetails"
...
func (c *objectBuilderServiceClient) GetObjectDetails(ctx context.Context, in *CommonMessage, opts ...grpc.CallOption) (*CommonMessage, error) {
	out := new(CommonMessage)
	err := c.cc.Invoke(ctx, ObjectBuilderService_GetObjectDetails_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
