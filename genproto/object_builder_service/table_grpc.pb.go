...
func (c *tableServiceClient) Update(ctx context.Context, in *Table, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
func (UnimplementedTableServiceServer) Update(context.Context, *Table) (*empty.Empty, error) {
