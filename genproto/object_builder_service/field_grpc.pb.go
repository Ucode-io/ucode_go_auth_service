...
type FieldServiceClient interface {
	...
	Update(ctx context.Context, in *Field, opts ...grpc.CallOption) (*empty.Empty, error)
...
func (c *fieldServiceClient) Update(ctx context.Context, in *Field, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
type FieldServiceServer interface {
	...
	Update(context.Context, *Field) (*empty.Empty, error)
...
func (UnimplementedFieldServiceServer) Update(context.Context, *Field) (*empty.Empty, error) {
