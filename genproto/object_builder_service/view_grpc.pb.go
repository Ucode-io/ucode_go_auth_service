...
type ViewServiceClient interface {
	...
	Update(ctx context.Context, in *View, opts ...grpc.CallOption) (*empty.Empty, error)
...
func (c *viewServiceClient) Update(ctx context.Context, in *View, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
type ViewServiceServer interface {
	...
	Update(context.Context, *View) (*empty.Empty, error)
...
func (UnimplementedViewServiceServer) Update(context.Context, *View) (*empty.Empty, error) {
