...
const (
	ViewService_Create_FullMethodName                = "/object_builder_service.ViewService/Create"
	ViewService_GetList_FullMethodName               = "/object_builder_service.ViewService/GetList"
	ViewService_GetSingle_FullMethodName             = "/object_builder_service.ViewService/GetSingle"
	ViewService_Update_FullMethodName                = "/object_builder_service.ViewService/Update"
	ViewService_Delete_FullMethodName                = "/object_builder_service.ViewService/Delete"
	ViewService_ConvertHtmlToPdf_FullMethodName      = "/object_builder_service.ViewService/ConvertHtmlToPdf"
	ViewService_ConvertTemplateToHtml_FullMethodName = "/object_builder_service.ViewService/ConvertTemplateToHtml"
	ViewService_UpdateViewOrder_FullMethodName       = "/object_builder_service.ViewService/UpdateViewOrder"
)
...
type ViewServiceClient interface {
	...
	UpdateViewOrder(ctx context.Context, in *UpdateViewOrderRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *viewServiceClient) Create(ctx context.Context, in *CreateViewRequest, opts ...grpc.CallOption) (*View, error) {
	out := new(View)
	err := c.cc.Invoke(ctx, ViewService_Create_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *viewServiceClient) GetList(ctx context.Context, in *GetAllViewsRequest, opts ...grpc.CallOption) (*GetAllViewsResponse, error) {
	...
	err := c.cc.Invoke(ctx, ViewService_GetList_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *viewServiceClient) GetSingle(ctx context.Context, in *ViewPrimaryKey, opts ...grpc.CallOption) (*View, error) {
	out := new(View)
	err := c.cc.Invoke(ctx, ViewService_GetSingle_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *viewServiceClient) Update(ctx context.Context, in *View, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, ViewService_Update_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *viewServiceClient) Delete(ctx context.Context, in *ViewPrimaryKey, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, ViewService_Delete_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *viewServiceClient) ConvertHtmlToPdf(ctx context.Context, in *HtmlBody, opts ...grpc.CallOption) (*PdfBody, error) {
	out := new(PdfBody)
	err := c.cc.Invoke(ctx, ViewService_ConvertHtmlToPdf_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *viewServiceClient) ConvertTemplateToHtml(ctx context.Context, in *HtmlBody, opts ...grpc.CallOption) (*HtmlBody, error) {
	out := new(HtmlBody)
	err := c.cc.Invoke(ctx, ViewService_ConvertTemplateToHtml_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *viewServiceClient) UpdateViewOrder(ctx context.Context, in *UpdateViewOrderRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, ViewService_UpdateViewOrder_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ViewServiceServer interface {
	...
	UpdateViewOrder(context.Context, *UpdateViewOrderRequest) (*emptypb.Empty, error)
...
func (UnimplementedViewServiceServer) UpdateViewOrder(context.Context, *UpdateViewOrderRequest) (*emptypb.Empty, error) {
