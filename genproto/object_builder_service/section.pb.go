...
type RelationForSection struct {
	...
	FieldPermissions  *_struct.Struct          `protobuf:"bytes,16,opt,name=field_permissions,json=fieldPermissions,proto3" json:"field_permissions,omitempty"`
}
...
func (x *RelationForSection) GetFieldPermissions() *_struct.Struct {
	if x != nil {
