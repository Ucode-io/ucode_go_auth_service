...
const (
	BarcodeService_Generate_FullMethodName               = "/postgres_object_builder_service.BarcodeService/Generate"
	BarcodeService_GenerateCodeWithPrefix_FullMethodName = "/postgres_object_builder_service.BarcodeService/GenerateCodeWithPrefix"
)
...
func (c *barcodeServiceClient) Generate(ctx context.Context, in *BarcodeGenerateReq, opts ...grpc.CallOption) (*BarcodeGenerateRes, error) {
	...
	err := c.cc.Invoke(ctx, BarcodeService_Generate_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *barcodeServiceClient) GenerateCodeWithPrefix(ctx context.Context, in *CodeGenerateReq, opts ...grpc.CallOption) (*CodeGenerateRes, error) {
	...
	err := c.cc.Invoke(ctx, BarcodeService_GenerateCodeWithPrefix_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var BarcodeService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "postgres_object_builder_service.BarcodeService",
	...
	Metadata: "postgres_barcode.proto",
}
