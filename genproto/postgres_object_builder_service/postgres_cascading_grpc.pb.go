...
const (
	CascadingService_GetCascadings_FullMethodName = "/postgres_object_builder_service.CascadingService/GetCascadings"
)
...
func (c *cascadingServiceClient) GetCascadings(ctx context.Context, in *GetCascadingRequest, opts ...grpc.CallOption) (*CommonMessage, error) {
	...
	err := c.cc.Invoke(ctx, CascadingService_GetCascadings_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
