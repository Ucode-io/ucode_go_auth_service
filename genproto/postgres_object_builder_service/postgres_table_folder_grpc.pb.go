...
const (
	TableFolderService_Create_FullMethodName  = "/postgres_object_builder_service.TableFolderService/Create"
	TableFolderService_GetByID_FullMethodName = "/postgres_object_builder_service.TableFolderService/GetByID"
	TableFolderService_GetAll_FullMethodName  = "/postgres_object_builder_service.TableFolderService/GetAll"
	TableFolderService_Update_FullMethodName  = "/postgres_object_builder_service.TableFolderService/Update"
	TableFolderService_Delete_FullMethodName  = "/postgres_object_builder_service.TableFolderService/Delete"
)
...
func (c *tableFolderServiceClient) Create(ctx context.Context, in *TableFolderRequest, opts ...grpc.CallOption) (*CreateTableFolderResponse, error) {
	...
	err := c.cc.Invoke(ctx, TableFolderService_Create_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *tableFolderServiceClient) GetByID(ctx context.Context, in *TableFolderPrimaryKey, opts ...grpc.CallOption) (*TableFolder, error) {
	out := new(TableFolder)
	err := c.cc.Invoke(ctx, TableFolderService_GetByID_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *tableFolderServiceClient) GetAll(ctx context.Context, in *GetAllTableFoldersRequest, opts ...grpc.CallOption) (*GetAllTableFoldersResponse, error) {
	...
	err := c.cc.Invoke(ctx, TableFolderService_GetAll_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *tableFolderServiceClient) Update(ctx context.Context, in *TableFolder, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, TableFolderService_Update_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *tableFolderServiceClient) Delete(ctx context.Context, in *TableFolderPrimaryKey, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, TableFolderService_Delete_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
