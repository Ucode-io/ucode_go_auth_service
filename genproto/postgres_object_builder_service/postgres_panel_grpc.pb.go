...
const (
	PanelService_Create_FullMethodName            = "/postgres_object_builder_service.PanelService/Create"
	PanelService_GetList_FullMethodName           = "/postgres_object_builder_service.PanelService/GetList"
	PanelService_GetSingle_FullMethodName         = "/postgres_object_builder_service.PanelService/GetSingle"
	PanelService_Update_FullMethodName            = "/postgres_object_builder_service.PanelService/Update"
	PanelService_UpdateCoordinates_FullMethodName = "/postgres_object_builder_service.PanelService/UpdateCoordinates"
	PanelService_Delete_FullMethodName            = "/postgres_object_builder_service.PanelService/Delete"
)
...
func (c *panelServiceClient) Create(ctx context.Context, in *CreatePanelRequest, opts ...grpc.CallOption) (*Panel, error) {
	out := new(Panel)
	err := c.cc.Invoke(ctx, PanelService_Create_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *panelServiceClient) GetList(ctx context.Context, in *GetAllPanelsRequest, opts ...grpc.CallOption) (*GetAllPanelsResponse, error) {
	...
	err := c.cc.Invoke(ctx, PanelService_GetList_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *panelServiceClient) GetSingle(ctx context.Context, in *PanelPrimaryKey, opts ...grpc.CallOption) (*Panel, error) {
	out := new(Panel)
	err := c.cc.Invoke(ctx, PanelService_GetSingle_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *panelServiceClient) Update(ctx context.Context, in *Panel, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, PanelService_Update_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *panelServiceClient) UpdateCoordinates(ctx context.Context, in *UpdatePanelCoordinatesRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, PanelService_UpdateCoordinates_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *panelServiceClient) Delete(ctx context.Context, in *PanelPrimaryKey, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, PanelService_Delete_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var PanelService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "postgres_object_builder_service.PanelService",
