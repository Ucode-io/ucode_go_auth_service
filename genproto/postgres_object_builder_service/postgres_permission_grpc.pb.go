...
const (
	PermissionService_UpsertPermissionsByAppId_FullMethodName           = "/postgres_object_builder_service.PermissionService/UpsertPermissionsByAppId"
	PermissionService_GetAllPermissionsByRoleId_FullMethodName          = "/postgres_object_builder_service.PermissionService/GetAllPermissionsByRoleId"
	PermissionService_GetFieldPermissions_FullMethodName                = "/postgres_object_builder_service.PermissionService/GetFieldPermissions"
	PermissionService_GetActionPermissions_FullMethodName               = "/postgres_object_builder_service.PermissionService/GetActionPermissions"
	PermissionService_GetViewRelationPermissions_FullMethodName         = "/postgres_object_builder_service.PermissionService/GetViewRelationPermissions"
	PermissionService_GetListWithRoleAppTablePermissions_FullMethodName = "/postgres_object_builder_service.PermissionService/GetListWithRoleAppTablePermissions"
	PermissionService_UpdateRoleAppTablePermissions_FullMethodName      = "/postgres_object_builder_service.PermissionService/UpdateRoleAppTablePermissions"
)
