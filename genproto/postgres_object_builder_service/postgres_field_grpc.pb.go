...
const (
	FieldService_Create_FullMethodName = "/postgres_object_builder_service.FieldService/Create"
	FieldService_GetAll_FullMethodName = "/postgres_object_builder_service.FieldService/GetAll"
	FieldService_Update_FullMethodName = "/postgres_object_builder_service.FieldService/Update"
	FieldService_Delete_FullMethodName = "/postgres_object_builder_service.FieldService/Delete"
)
...
func (c *fieldServiceClient) Create(ctx context.Context, in *CreateFieldRequest, opts ...grpc.CallOption) (*Field, error) {
	out := new(Field)
	err := c.cc.Invoke(ctx, FieldService_Create_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *fieldServiceClient) GetAll(ctx context.Context, in *GetAllFieldsRequest, opts ...grpc.CallOption) (*GetAllFieldsResponse, error) {
	...
	err := c.cc.Invoke(ctx, FieldService_GetAll_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *fieldServiceClient) Update(ctx context.Context, in *Field, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, FieldService_Update_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *fieldServiceClient) Delete(ctx context.Context, in *FieldPrimaryKey, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, FieldService_Delete_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var FieldService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "postgres_object_builder_service.FieldService",
