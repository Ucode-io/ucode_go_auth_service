...
const (
	FieldAndRelationService_CreateFieldsAndRelations_FullMethodName = "/postgres_object_builder_service.FieldAndRelationService/CreateFieldsAndRelations"
)
...
func (c *fieldAndRelationServiceClient) CreateFieldsAndRelations(ctx context.Context, in *CreateFieldsAndRelationsRequest, opts ...grpc.CallOption) (*CreateFieldsAndRelationsResponse, error) {
	...
	err := c.cc.Invoke(ctx, FieldAndRelationService_CreateFieldsAndRelations_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
