...
const (
	VariableService_Create_FullMethodName    = "/postgres_object_builder_service.VariableService/Create"
	VariableService_GetList_FullMethodName   = "/postgres_object_builder_service.VariableService/GetList"
	VariableService_GetSingle_FullMethodName = "/postgres_object_builder_service.VariableService/GetSingle"
	VariableService_Update_FullMethodName    = "/postgres_object_builder_service.VariableService/Update"
	VariableService_Delete_FullMethodName    = "/postgres_object_builder_service.VariableService/Delete"
)
...
func (c *variableServiceClient) Create(ctx context.Context, in *CreateVariableRequest, opts ...grpc.CallOption) (*Variable, error) {
	out := new(Variable)
	err := c.cc.Invoke(ctx, VariableService_Create_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *variableServiceClient) GetList(ctx context.Context, in *GetAllVariablesRequest, opts ...grpc.CallOption) (*GetAllVariablesResponse, error) {
	...
	err := c.cc.Invoke(ctx, VariableService_GetList_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *variableServiceClient) GetSingle(ctx context.Context, in *VariablePrimaryKey, opts ...grpc.CallOption) (*Variable, error) {
	out := new(Variable)
	err := c.cc.Invoke(ctx, VariableService_GetSingle_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *variableServiceClient) Update(ctx context.Context, in *Variable, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, VariableService_Update_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *variableServiceClient) Delete(ctx context.Context, in *VariablePrimaryKey, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, VariableService_Delete_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
