...
const (
	DashboardService_Create_FullMethodName    = "/postgres_object_builder_service.DashboardService/Create"
	DashboardService_GetList_FullMethodName   = "/postgres_object_builder_service.DashboardService/GetList"
	DashboardService_GetSingle_FullMethodName = "/postgres_object_builder_service.DashboardService/GetSingle"
	DashboardService_Update_FullMethodName    = "/postgres_object_builder_service.DashboardService/Update"
	DashboardService_Delete_FullMethodName    = "/postgres_object_builder_service.DashboardService/Delete"
)
...
func (c *dashboardServiceClient) GetList(ctx context.Context, in *GetAllDashboardsRequest, opts ...grpc.CallOption) (*GetAllDashboadsResponse, error) {
	...
	err := c.cc.Invoke(ctx, DashboardService_GetList_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *dashboardServiceClient) GetSingle(ctx context.Context, in *DashboardPrimaryKey, opts ...grpc.CallOption) (*Dashboard, error) {
	out := new(Dashboard)
	err := c.cc.Invoke(ctx, DashboardService_GetSingle_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
