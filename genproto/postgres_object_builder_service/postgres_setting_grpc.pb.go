...
const (
	SettingService_GetDefaultSettings_FullMethodName = "/postgres_object_builder_service.SettingService/GetDefaultSettings"
	SettingService_GetAll_FullMethodName             = "/postgres_object_builder_service.SettingService/GetAll"
	SettingService_SetDefaultSettings_FullMethodName = "/postgres_object_builder_service.SettingService/SetDefaultSettings"
)
...
func (c *settingServiceClient) GetDefaultSettings(ctx context.Context, in *GetDefaultSettingsReq, opts ...grpc.CallOption) (*GetDefaultSettingsRes, error) {
	...
	err := c.cc.Invoke(ctx, SettingService_GetDefaultSettings_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *settingServiceClient) GetAll(ctx context.Context, in *GetAllReq, opts ...grpc.CallOption) (*Setting, error) {
	out := new(Setting)
	err := c.cc.Invoke(ctx, SettingService_GetAll_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *settingServiceClient) SetDefaultSettings(ctx context.Context, in *SetDefaultSettingsReq, opts ...grpc.CallOption) (*Setting, error) {
	out := new(Setting)
	err := c.cc.Invoke(ctx, SettingService_SetDefaultSettings_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var SettingService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "postgres_object_builder_service.SettingService",
	...
	Metadata: "postgres_setting.proto",
}
