...
const (
	SectionService_GetAll_FullMethodName              = "/postgres_object_builder_service.SectionService/GetAll"
	SectionService_Update_FullMethodName              = "/postgres_object_builder_service.SectionService/Update"
	SectionService_GetAllViewRelations_FullMethodName = "/postgres_object_builder_service.SectionService/GetAllViewRelations"
	SectionService_GetViewRelation_FullMethodName     = "/postgres_object_builder_service.SectionService/GetViewRelation"
	SectionService_UpsertViewRelations_FullMethodName = "/postgres_object_builder_service.SectionService/UpsertViewRelations"
)
...
func (c *sectionServiceClient) GetAll(ctx context.Context, in *GetAllSectionsRequest, opts ...grpc.CallOption) (*GetAllSectionsResponse, error) {
	...
	err := c.cc.Invoke(ctx, SectionService_GetAll_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *sectionServiceClient) Update(ctx context.Context, in *UpdateSectionsRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, SectionService_Update_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *sectionServiceClient) GetAllViewRelations(ctx context.Context, in *GetAllSectionsRequest, opts ...grpc.CallOption) (*GetAllViewRelationsResponse, error) {
	...
	err := c.cc.Invoke(ctx, SectionService_GetAllViewRelations_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *sectionServiceClient) GetViewRelation(ctx context.Context, in *GetAllSectionsRequest, opts ...grpc.CallOption) (*GetViewRelationResponse, error) {
	...
	err := c.cc.Invoke(ctx, SectionService_GetViewRelation_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *sectionServiceClient) UpsertViewRelations(ctx context.Context, in *UpsertViewRelationsBody, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, SectionService_UpsertViewRelations_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var SectionService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "postgres_object_builder_service.SectionService",
	...
	Metadata: "postgres_section.proto",
}
