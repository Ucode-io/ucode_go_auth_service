...
const (
	TableService_Create_FullMethodName                 = "/postgres_object_builder_service.TableService/Create"
	TableService_GetByID_FullMethodName                = "/postgres_object_builder_service.TableService/GetByID"
	TableService_GetAll_FullMethodName                 = "/postgres_object_builder_service.TableService/GetAll"
	TableService_Update_FullMethodName                 = "/postgres_object_builder_service.TableService/Update"
	TableService_Delete_FullMethodName                 = "/postgres_object_builder_service.TableService/Delete"
	TableService_GetListTableHistory_FullMethodName    = "/postgres_object_builder_service.TableService/GetListTableHistory"
	TableService_GetTableHistoryById_FullMethodName    = "/postgres_object_builder_service.TableService/GetTableHistoryById"
	TableService_RevertTableHistory_FullMethodName     = "/postgres_object_builder_service.TableService/RevertTableHistory"
	TableService_InsertVersionsToCommit_FullMethodName = "/postgres_object_builder_service.TableService/InsertVersionsToCommit"
)
...
func (c *tableServiceClient) GetByID(ctx context.Context, in *TablePrimaryKey, opts ...grpc.CallOption) (*Table, error) {
	out := new(Table)
	err := c.cc.Invoke(ctx, TableService_GetByID_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *tableServiceClient) GetAll(ctx context.Context, in *GetAllTablesRequest, opts ...grpc.CallOption) (*GetAllTablesResponse, error) {
	...
	err := c.cc.Invoke(ctx, TableService_GetAll_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *tableServiceClient) Update(ctx context.Context, in *Table, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, TableService_Update_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *tableServiceClient) GetListTableHistory(ctx context.Context, in *GetTableHistoryRequest, opts ...grpc.CallOption) (*GetTableHistoryResponse, error) {
	...
	err := c.cc.Invoke(ctx, TableService_GetListTableHistory_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *tableServiceClient) GetTableHistoryById(ctx context.Context, in *TableHistoryPrimaryKey, opts ...grpc.CallOption) (*TableHistory, error) {
	...
	err := c.cc.Invoke(ctx, TableService_GetTableHistoryById_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *tableServiceClient) RevertTableHistory(ctx context.Context, in *TableHistoryPrimaryKey, opts ...grpc.CallOption) (*TableHistory, error) {
	out := new(TableHistory)
	err := c.cc.Invoke(ctx, TableService_RevertTableHistory_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *tableServiceClient) InsertVersionsToCommit(ctx context.Context, in *InsertVersionsToCommitRequest, opts ...grpc.CallOption) (*TableHistory, error) {
	out := new(TableHistory)
	err := c.cc.Invoke(ctx, TableService_InsertVersionsToCommit_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
