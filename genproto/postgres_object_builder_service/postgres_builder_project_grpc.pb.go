...
const (
	BuilderProjectService_Register_FullMethodName         = "/postgres_object_builder_service.BuilderProjectService/Register"
	BuilderProjectService_RegisterProjects_FullMethodName = "/postgres_object_builder_service.BuilderProjectService/RegisterProjects"
	BuilderProjectService_Deregister_FullMethodName       = "/postgres_object_builder_service.BuilderProjectService/Deregister"
	BuilderProjectService_Reconnect_FullMethodName        = "/postgres_object_builder_service.BuilderProjectService/Reconnect"
	BuilderProjectService_RegisterMany_FullMethodName     = "/postgres_object_builder_service.BuilderProjectService/RegisterMany"
	BuilderProjectService_DeregisterMany_FullMethodName   = "/postgres_object_builder_service.BuilderProjectService/DeregisterMany"
)
...
func (c *builderProjectServiceClient) Register(ctx context.Context, in *RegisterProjectRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, BuilderProjectService_Register_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *builderProjectServiceClient) RegisterProjects(ctx context.Context, in *RegisterProjectRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, BuilderProjectService_RegisterProjects_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *builderProjectServiceClient) Deregister(ctx context.Context, in *DeregisterProjectRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, BuilderProjectService_Deregister_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *builderProjectServiceClient) Reconnect(ctx context.Context, in *RegisterProjectRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, BuilderProjectService_Reconnect_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *builderProjectServiceClient) RegisterMany(ctx context.Context, in *RegisterManyProjectsRequest, opts ...grpc.CallOption) (*RegisterManyProjectsResponse, error) {
	...
	err := c.cc.Invoke(ctx, BuilderProjectService_RegisterMany_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *builderProjectServiceClient) DeregisterMany(ctx context.Context, in *DeregisterManyProjectsRequest, opts ...grpc.CallOption) (*DeregisterManyProjectsResponse, error) {
	...
	err := c.cc.Invoke(ctx, BuilderProjectService_DeregisterMany_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var BuilderProjectService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "postgres_object_builder_service.BuilderProjectService",
	...
	Metadata: "postgres_builder_project.proto",
}
