...
const (
	ExcelService_ExcelRead_FullMethodName = "/postgres_object_builder_service.ExcelService/ExcelRead"
	ExcelService_ExcelToDb_FullMethodName = "/postgres_object_builder_service.ExcelService/ExcelToDb"
)
...
func (c *excelServiceClient) ExcelRead(ctx context.Context, in *ExcelReadRequest, opts ...grpc.CallOption) (*ExcelReadResponse, error) {
	...
	err := c.cc.Invoke(ctx, ExcelService_ExcelRead_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *excelServiceClient) ExcelToDb(ctx context.Context, in *ExcelToDbRequest, opts ...grpc.CallOption) (*ExcelToDbResponse, error) {
	...
	err := c.cc.Invoke(ctx, ExcelService_ExcelToDb_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
